...
int CELEBW02(void){
  ...
  else do { //note the do..while loop for the parent process. Because of this
// loop, we have "child is still running" multiple times, and then final
// exit statement of parent. If there were no do..while loop, then only
