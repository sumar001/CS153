...
801002c3:	e8 a8 39 00 00       	call   80103c70 <sleep>
    while(input.r == input.w){
...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 e7 79 10 80 	movl   $0x801079e7,(%esp)
...
80100409:	e8 c2 57 00 00       	call   80105bd0 <uartputc>
...
801004b9:	e8 12 57 00 00       	call   80105bd0 <uartputc>
801004be:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004c5:	e8 06 57 00 00       	call   80105bd0 <uartputc>
801004ca:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
801004d1:	e8 fa 56 00 00       	call   80105bd0 <uartputc>
...
80100927:	e9 e4 35 00 00       	jmp    80103f10 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
...
80100a2a:	75 d4                	jne    80100a00 <exec+0x60>
  if((pgdir = setupkvm()) == 0)
80100a2c:	e8 8f 63 00 00       	call   80106dc0 <setupkvm>
...
80100ad2:	e8 59 61 00 00       	call   80106c30 <allocuvm>
...
80100b13:	e8 58 60 00 00       	call   80106b70 <loaduvm>
...
80100b6c:	e8 bf 60 00 00       	call   80106c30 <allocuvm>
...
80100b84:	e8 b7 61 00 00       	call   80106d40 <freevm>
  return -1;
...
80100bc8:	e8 a3 62 00 00       	call   80106e70 <clearpteu>
...
80100c31:	e8 9a 63 00 00       	call   80106fd0 <copyout>
...
80100c9e:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100ca4:	e8 27 63 00 00       	call   80106fd0 <copyout>
...
80100d1f:	e8 bc 5c 00 00       	call   801069e0 <switchuvm>
  freevm(oldpgdir);
80100d24:	89 34 24             	mov    %esi,(%esp)
80100d27:	e8 14 60 00 00       	call   80106d40 <freevm>
  return 0;
...
80101164:	c3                   	ret    
    panic("freeing free block");
80101165:	c7 04 24 1f 71 10 80 	movl   $0x8010711f,(%esp)
...
80101225:	c7 04 24 32 71 10 80 	movl   $0x80107132,(%esp)
...
8010134d:	c7 04 24 48 71 10 80 	movl   $0x80107148,(%esp)
...
80101405:	eb 93                	jmp    8010139a <bmap+0x3a>
  panic("bmap: out of range");
80101407:	c7 04 24 58 71 10 80 	movl   $0x80107158,(%esp)
...
8010147c:	c7 44 24 04 6b 71 10 	movl   $0x8010716b,0x4(%esp)
80101483:	80 
...
80101499:	c7 44 24 04 72 71 10 	movl   $0x80107172,0x4(%esp)
801014a0:	80 
...
801014c6:	c7 04 24 d8 71 10 80 	movl   $0x801071d8,(%esp)
...
801015e1:	c7 04 24 78 71 10 80 	movl   $0x80107178,(%esp)
...
80101764:	0f 85 76 ff ff ff    	jne    801016e0 <ilock+0x30>
      panic("ilock: no type");
8010176a:	c7 04 24 90 71 10 80 	movl   $0x80107190,(%esp)
80101771:	e8 ea eb ff ff       	call   80100360 <panic>
    panic("ilock");
80101776:	c7 04 24 8a 71 10 80 	movl   $0x8010718a,(%esp)
...
801017be:	e9 6d 2b 00 00       	jmp    80104330 <releasesleep>
    panic("iunlock");
801017c3:	c7 04 24 9f 71 10 80 	movl   $0x8010719f,(%esp)
...
80101c61:	c3                   	ret    
      panic("dirlookup read");
80101c62:	c7 04 24 b9 71 10 80 	movl   $0x801071b9,(%esp)
80101c69:	e8 f2 e6 ff ff       	call   80100360 <panic>
    panic("dirlookup not DIR");
80101c6e:	c7 04 24 a7 71 10 80 	movl   $0x801071a7,(%esp)
...
80101ee3:	eb e9                	jmp    80101ece <dirlink+0xae>
      panic("dirlink read");
80101ee5:	c7 04 24 c8 71 10 80 	movl   $0x801071c8,(%esp)
80101eec:	e8 6f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101ef1:	c7 04 24 ce 77 10 80 	movl   $0x801077ce,(%esp)
...
80101fdf:	c7 04 24 34 72 10 80 	movl   $0x80107234,(%esp)
80101fe6:	e8 75 e3 ff ff       	call   80100360 <panic>
    panic("idestart");
80101feb:	c7 04 24 2b 72 10 80 	movl   $0x8010722b,(%esp)
...
80102006:	c7 44 24 04 46 72 10 	movl   $0x80107246,0x4(%esp)
8010200d:	80 
...
801021ab:	e8 c0 1a 00 00       	call   80103c70 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
801021d9:	eb bb                	jmp    80102196 <iderw+0x76>
    panic("iderw: buf not locked");
801021db:	c7 04 24 4a 72 10 80 	movl   $0x8010724a,(%esp)
801021e2:	e8 79 e1 ff ff       	call   80100360 <panic>
    panic("iderw: ide disk 1 not present");
801021e7:	c7 04 24 75 72 10 80 	movl   $0x80107275,(%esp)
801021ee:	e8 6d e1 ff ff       	call   80100360 <panic>
    panic("iderw: nothing to do");
801021f3:	c7 04 24 60 72 10 80 	movl   $0x80107260,(%esp)
...
80102248:	c7 04 24 94 72 10 80 	movl   $0x80107294,(%esp)
...
8010237c:	eb bb                	jmp    80102339 <kfree+0x49>
    panic("kfree");
8010237e:	c7 04 24 c6 72 10 80 	movl   $0x801072c6,(%esp)
...
801023eb:	c7 44 24 04 cc 72 10 	movl   $0x801072cc,0x4(%esp)
801023f2:	80 
...
80102534:	0f b6 81 00 74 10 80 	movzbl -0x7fef8c00(%ecx),%eax
...
80102568:	0f b6 91 00 74 10 80 	movzbl -0x7fef8c00(%ecx),%edx
  shift ^= togglecode[data];
8010256f:	0f b6 81 00 73 10 80 	movzbl -0x7fef8d00(%ecx),%eax
  shift |= shiftcode[data];
...
8010257f:	8b 04 85 e0 72 10 80 	mov    -0x7fef8d20(,%eax,4),%eax
  shift ^= togglecode[data];
...
80102a7b:	c7 44 24 04 00 75 10 	movl   $0x80107500,0x4(%esp)
80102a82:	80 
...
80102b37:	e8 34 11 00 00       	call   80103c70 <sleep>
    if(log.committing){
...
80102ca2:	c3                   	ret    
    panic("log.committing");
80102ca3:	c7 04 24 04 75 10 80 	movl   $0x80107504,(%esp)
...
80102d5d:	8d 76 00             	lea    0x0(%esi),%esi
    panic("too big a transaction");
80102d60:	c7 04 24 13 75 10 80 	movl   $0x80107513,(%esp)
80102d67:	e8 f4 d5 ff ff       	call   80100360 <panic>
    panic("log_write outside of trans");
80102d6c:	c7 04 24 29 75 10 80 	movl   $0x80107529,(%esp)
...
80102d97:	c7 04 24 44 75 10 80 	movl   $0x80107544,(%esp)
80102d9e:	89 44 24 04          	mov    %eax,0x4(%esp)
80102da2:	e8 a9 d8 ff ff       	call   80100650 <cprintf>
  idtinit();       // load idt register
80102da7:	e8 54 2b 00 00       	call   80105900 <idtinit>
...
80102dd3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dd6:	e8 e5 3b 00 00       	call   801069c0 <switchkvm>
  seginit();
80102ddb:	e8 20 3b 00 00       	call   80106900 <seginit>
  lapicinit();
...
80102e13:	e8 38 40 00 00       	call   80106e50 <kvmalloc>
...
80102e25:	e8 d6 3a 00 00       	call   80106900 <seginit>
  picinit();       // disable pic
...
80102e3a:	e8 e1 2d 00 00       	call   80105c20 <uartinit>
80102e3f:	90                   	nop
  pinit();         // process table
80102e40:	e8 ab 07 00 00       	call   801035f0 <pinit>
  tvinit();        // trap vectors
80102e45:	e8 16 2a 00 00       	call   80105860 <tvinit>
  binit();         // buffer cache
...
80102f3f:	00 
80102f40:	c7 44 24 04 58 75 10 	movl   $0x80107558,0x4(%esp)
80102f47:	80 
...
80102ffa:	00 
80102ffb:	c7 44 24 04 5d 75 10 	movl   $0x8010755d,0x4(%esp)
80103002:	80 
...
8010308c:	ff 24 8d 9c 75 10 80 	jmp    *-0x7fef8a64(,%ecx,4)
80103093:	90                   	nop
...
80103117:	0f 85 c5 fe ff ff    	jne    80102fe2 <mpinit+0x52>
    panic("Expect to run on an SMP");
8010311d:	c7 04 24 62 75 10 80 	movl   $0x80107562,(%esp)
...
80103138:	eb e3                	jmp    8010311d <mpinit+0x18d>
    panic("Didn't find a suitable machine");
8010313a:	c7 04 24 7c 75 10 80 	movl   $0x8010757c,(%esp)
...
801031df:	c7 44 24 04 b0 75 10 	movl   $0x801075b0,0x4(%esp)
801031e6:	80 
...
8010335b:	e8 10 09 00 00       	call   80103c70 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
8010341f:	e8 4c 08 00 00       	call   80103c70 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
80103515:	89 43 10             	mov    %eax,0x10(%ebx)
  release(&ptable.lock);
80103518:	e8 83 10 00 00       	call   801045a0 <release>
...
80103534:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103537:	c7 40 14 51 58 10 80 	movl   $0x80105851,0x14(%eax)
...
80103551:	89 43 1c             	mov    %eax,0x1c(%ebx)
  memset(p->context, 0, sizeof *p->context);
80103554:	e8 97 10 00 00       	call   801045f0 <memset>
  p->context->eip = (uint)forkret;
80103559:	8b 43 1c             	mov    0x1c(%ebx),%eax
8010355c:	c7 40 10 a0 35 10 80 	movl   $0x801035a0,0x10(%eax)
  p->priority = 10; //added for assignment2
  return p;
80103563:	89 d8                	mov    %ebx,%eax
  p->priority = 10; //added for assignment2
80103565:	c7 83 80 00 00 00 0a 	movl   $0xa,0x80(%ebx)
8010356c:	00 00 00 
}
...
8010357f:	e8 1c 10 00 00       	call   801045a0 <release>
}
...
801035ad:	e8 ee 0f 00 00       	call   801045a0 <release>
...
80103605:	e8 b6 0d 00 00       	call   801043c0 <initlock>
}
8010360a:	c9                   	leave  
8010360b:	c3                   	ret    
...
801036b4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801036b7:	e8 84 0d 00 00       	call   80104440 <pushcli>
  c = mycpu();
801036bc:	e8 4f ff ff ff       	call   80103610 <mycpu>
  p = c->proc;
801036c1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801036c7:	e8 b4 0d 00 00       	call   80104480 <popcli>
}
...
801036f3:	e8 c8 36 00 00       	call   80106dc0 <setupkvm>
...
80103715:	80 
80103716:	e8 d5 33 00 00       	call   80106af0 <inituvm>
  p->sz = PGSIZE;
...
80103737:	e8 b4 0e 00 00       	call   801045f0 <memset>
...
8010379e:	e8 2d 10 00 00       	call   801047d0 <safestrcpy>
  p->cwd = namei("/");
...
80103819:	e8 12 34 00 00       	call   80106c30 <allocuvm>
...
80103827:	e8 b4 31 00 00       	call   801069e0 <switchuvm>
  return 0;
...
8010384a:	e8 d1 34 00 00       	call   80106d20 <deallocuvm>
...
8010388e:	e8 0d 36 00 00       	call   80106ea0 <copyuvm>
...
80103991:	bf 54 2d 11 80       	mov    $0x80112d54,%edi
    acquire(&ptable.lock);
80103996:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010399d:	e8 8e 0b 00 00       	call   80104530 <acquire>
    int highestPriority = nextProc->priority;
801039a2:	8b 0d d4 2d 11 80    	mov    0x80112dd4,%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801039a8:	89 fa                	mov    %edi,%edx
801039aa:	eb 12                	jmp    801039be <scheduler+0x4e>
801039ac:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801039b0:	81 c2 84 00 00 00    	add    $0x84,%edx
801039b6:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
801039bc:	74 32                	je     801039f0 <scheduler+0x80>
      if(p->state != RUNNABLE || p == nextProc) continue;
801039be:	83 7a 0c 03          	cmpl   $0x3,0xc(%edx)
801039c2:	75 ec                	jne    801039b0 <scheduler+0x40>
801039c4:	39 fa                	cmp    %edi,%edx
801039c6:	74 e8                	je     801039b0 <scheduler+0x40>
      if(p->priority < highestPriority) {
801039c8:	8b 82 80 00 00 00    	mov    0x80(%edx),%eax
801039ce:	39 c8                	cmp    %ecx,%eax
801039d0:	7d 76                	jge    80103a48 <scheduler+0xd8>
	nextProc->priority = nextProc->priority - 1;
801039d2:	83 af 80 00 00 00 01 	subl   $0x1,0x80(%edi)
801039d9:	89 d7                	mov    %edx,%edi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
801039db:	81 c2 84 00 00 00    	add    $0x84,%edx
801039e1:	89 c1                	mov    %eax,%ecx
801039e3:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
801039e9:	75 d3                	jne    801039be <scheduler+0x4e>
801039eb:	90                   	nop
801039ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(nextProc->priority < 31) {
801039f0:	8b 87 80 00 00 00    	mov    0x80(%edi),%eax
801039f6:	83 f8 1e             	cmp    $0x1e,%eax
801039f9:	7f 09                	jg     80103a04 <scheduler+0x94>
      nextProc->priority = nextProc->priority + 1;
801039fb:	83 c0 01             	add    $0x1,%eax
801039fe:	89 87 80 00 00 00    	mov    %eax,0x80(%edi)
    c->proc = nextProc;
80103a04:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
    switchuvm(nextProc);
80103a0a:	89 3c 24             	mov    %edi,(%esp)
80103a0d:	e8 ce 2f 00 00       	call   801069e0 <switchuvm>
    swtch(&(c->scheduler), nextProc->context);
80103a12:	8b 47 1c             	mov    0x1c(%edi),%eax
    nextProc->state = RUNNING;
80103a15:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
    swtch(&(c->scheduler), nextProc->context);
80103a1c:	89 34 24             	mov    %esi,(%esp)
80103a1f:	89 44 24 04          	mov    %eax,0x4(%esp)
80103a23:	e8 03 0e 00 00       	call   8010482b <swtch>
    switchkvm();
80103a28:	e8 93 2f 00 00       	call   801069c0 <switchkvm>
    c->proc = 0;
80103a2d:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103a34:	00 00 00 
    release(&ptable.lock);
80103a37:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a3e:	e8 5d 0b 00 00       	call   801045a0 <release>
  } //end of first for loop which runs forever.
80103a43:	e9 48 ff ff ff       	jmp    80103990 <scheduler+0x20>
	if(p->priority > 0) p->priority = p->priority - 1;
80103a48:	85 c0                	test   %eax,%eax
80103a4a:	0f 8e 60 ff ff ff    	jle    801039b0 <scheduler+0x40>
80103a50:	83 e8 01             	sub    $0x1,%eax
80103a53:	89 82 80 00 00 00    	mov    %eax,0x80(%edx)
80103a59:	e9 52 ff ff ff       	jmp    801039b0 <scheduler+0x40>
...
80103ace:	c7 04 24 f0 75 10 80 	movl   $0x801075f0,(%esp)
80103ad5:	e8 86 c8 ff ff       	call   80100360 <panic>
    panic("sched interruptible");
80103ada:	c7 04 24 1c 76 10 80 	movl   $0x8010761c,(%esp)
80103ae1:	e8 7a c8 ff ff       	call   80100360 <panic>
    panic("sched running");
80103ae6:	c7 04 24 0e 76 10 80 	movl   $0x8010760e,(%esp)
80103aed:	e8 6e c8 ff ff       	call   80100360 <panic>
    panic("sched locks");
80103af2:	c7 04 24 02 76 10 80 	movl   $0x80107602,(%esp)
...
80103b07:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103b0a:	e8 a1 fb ff ff       	call   801036b0 <myproc>
  if(curproc == initproc)
80103b0f:	3b 05 b8 a5 10 80    	cmp    0x8010a5b8,%eax
  struct proc *curproc = myproc();
80103b15:	89 c3                	mov    %eax,%ebx
  if(curproc == initproc)
80103b17:	0f 84 fd 00 00 00    	je     80103c1a <exit+0x11a>
...
80103b63:	e8 c8 09 00 00       	call   80104530 <acquire>
...
80103b70:	eb 14                	jmp    80103b86 <exit+0x86>
...
80103b84:	74 20                	je     80103ba6 <exit+0xa6>
    if(p->state == SLEEPING && p->chan == chan)
80103b86:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103b8a:	75 ec                	jne    80103b78 <exit+0x78>
80103b8c:	3b 42 20             	cmp    0x20(%edx),%eax
80103b8f:	75 e7                	jne    80103b78 <exit+0x78>
      p->state = RUNNABLE;
80103b91:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103b98:	81 c2 84 00 00 00    	add    $0x84,%edx
80103b9e:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80103ba4:	75 e0                	jne    80103b86 <exit+0x86>
      p->parent = initproc;
80103ba6:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
80103bab:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
80103bb0:	eb 14                	jmp    80103bc6 <exit+0xc6>
80103bb2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103bb8:	81 c1 84 00 00 00    	add    $0x84,%ecx
80103bbe:	81 f9 54 4e 11 80    	cmp    $0x80114e54,%ecx
80103bc4:	74 3c                	je     80103c02 <exit+0x102>
    if(p->parent == curproc){
80103bc6:	39 59 14             	cmp    %ebx,0x14(%ecx)
80103bc9:	75 ed                	jne    80103bb8 <exit+0xb8>
      if(p->state == ZOMBIE)
80103bcb:	83 79 0c 05          	cmpl   $0x5,0xc(%ecx)
      p->parent = initproc;
80103bcf:	89 41 14             	mov    %eax,0x14(%ecx)
      if(p->state == ZOMBIE)
80103bd2:	75 e4                	jne    80103bb8 <exit+0xb8>
80103bd4:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80103bd9:	eb 13                	jmp    80103bee <exit+0xee>
80103bdb:	90                   	nop
...
80103bec:	74 ca                	je     80103bb8 <exit+0xb8>
    if(p->state == SLEEPING && p->chan == chan)
80103bee:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
80103bf2:	75 ec                	jne    80103be0 <exit+0xe0>
80103bf4:	3b 42 20             	cmp    0x20(%edx),%eax
80103bf7:	75 e7                	jne    80103be0 <exit+0xe0>
      p->state = RUNNABLE;
80103bf9:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
80103c00:	eb de                	jmp    80103be0 <exit+0xe0>
  curproc->state = ZOMBIE;
80103c02:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  sched();
80103c09:	e8 52 fe ff ff       	call   80103a60 <sched>
  panic("zombie exit");
80103c0e:	c7 04 24 3d 76 10 80 	movl   $0x8010763d,(%esp)
80103c15:	e8 46 c7 ff ff       	call   80100360 <panic>
    panic("init exiting");
80103c1a:	c7 04 24 30 76 10 80 	movl   $0x80107630,(%esp)
80103c21:	e8 3a c7 ff ff       	call   80100360 <panic>
...
80103c36:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103c3d:	e8 ee 08 00 00       	call   80104530 <acquire>
  myproc()->state = RUNNABLE;
80103c42:	e8 69 fa ff ff       	call   801036b0 <myproc>
80103c47:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  sched();
80103c4e:	e8 0d fe ff ff       	call   80103a60 <sched>
  release(&ptable.lock);
80103c53:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103c5a:	e8 41 09 00 00       	call   801045a0 <release>
}
80103c5f:	c9                   	leave  
80103c60:	c3                   	ret    
80103c61:	eb 0d                	jmp    80103c70 <sleep>
80103c63:	90                   	nop
80103c64:	90                   	nop
80103c65:	90                   	nop
80103c66:	90                   	nop
...
80103c79:	8b 7d 08             	mov    0x8(%ebp),%edi
80103c7c:	8b 75 0c             	mov    0xc(%ebp),%esi
  struct proc *p = myproc();
80103c7f:	e8 2c fa ff ff       	call   801036b0 <myproc>
  if(p == 0)
80103c84:	85 c0                	test   %eax,%eax
  struct proc *p = myproc();
80103c86:	89 c3                	mov    %eax,%ebx
  if(p == 0)
80103c88:	0f 84 7c 00 00 00    	je     80103d0a <sleep+0x9a>
  if(lk == 0)
80103c8e:	85 f6                	test   %esi,%esi
80103c90:	74 6c                	je     80103cfe <sleep+0x8e>
  if(lk != &ptable.lock){  //DOC: sleeplock0
80103c92:	81 fe 20 2d 11 80    	cmp    $0x80112d20,%esi
80103c98:	74 46                	je     80103ce0 <sleep+0x70>
    acquire(&ptable.lock);  //DOC: sleeplock1
80103c9a:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ca1:	e8 8a 08 00 00       	call   80104530 <acquire>
    release(lk);
80103ca6:	89 34 24             	mov    %esi,(%esp)
80103ca9:	e8 f2 08 00 00       	call   801045a0 <release>
  p->chan = chan;
80103cae:	89 7b 20             	mov    %edi,0x20(%ebx)
  p->state = SLEEPING;
80103cb1:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103cb8:	e8 a3 fd ff ff       	call   80103a60 <sched>
  p->chan = 0;
80103cbd:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
80103cc4:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ccb:	e8 d0 08 00 00       	call   801045a0 <release>
    acquire(lk);
80103cd0:	89 75 08             	mov    %esi,0x8(%ebp)
}
80103cd3:	83 c4 1c             	add    $0x1c,%esp
80103cd6:	5b                   	pop    %ebx
80103cd7:	5e                   	pop    %esi
80103cd8:	5f                   	pop    %edi
80103cd9:	5d                   	pop    %ebp
    acquire(lk);
80103cda:	e9 51 08 00 00       	jmp    80104530 <acquire>
80103cdf:	90                   	nop
  p->chan = chan;
80103ce0:	89 78 20             	mov    %edi,0x20(%eax)
  p->state = SLEEPING;
80103ce3:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
  sched();
80103cea:	e8 71 fd ff ff       	call   80103a60 <sched>
  p->chan = 0;
80103cef:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
}
80103cf6:	83 c4 1c             	add    $0x1c,%esp
80103cf9:	5b                   	pop    %ebx
80103cfa:	5e                   	pop    %esi
80103cfb:	5f                   	pop    %edi
80103cfc:	5d                   	pop    %ebp
...
80103cfe:	c7 04 24 4f 76 10 80 	movl   $0x8010764f,(%esp)
80103d05:	e8 56 c6 ff ff       	call   80100360 <panic>
    panic("sleep");
80103d0a:	c7 04 24 49 76 10 80 	movl   $0x80107649,(%esp)
80103d11:	e8 4a c6 ff ff       	call   80100360 <panic>
...
80103d29:	8b 7d 08             	mov    0x8(%ebp),%edi
  struct proc *curproc = myproc();
80103d2c:	e8 7f f9 ff ff       	call   801036b0 <myproc>
  acquire(&ptable.lock);
80103d31:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *curproc = myproc();
80103d38:	89 c6                	mov    %eax,%esi
  acquire(&ptable.lock);
80103d3a:	e8 f1 07 00 00       	call   80104530 <acquire>
    havekids = 0;
80103d3f:	31 c0                	xor    %eax,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d41:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80103d46:	eb 0e                	jmp    80103d56 <wait+0x36>
80103d48:	81 c3 84 00 00 00    	add    $0x84,%ebx
80103d4e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103d54:	74 22                	je     80103d78 <wait+0x58>
      if(p->parent != curproc)
80103d56:	39 73 14             	cmp    %esi,0x14(%ebx)
80103d59:	75 ed                	jne    80103d48 <wait+0x28>
      if(p->state == ZOMBIE){
80103d5b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80103d5f:	74 34                	je     80103d95 <wait+0x75>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d61:	81 c3 84 00 00 00    	add    $0x84,%ebx
      havekids = 1;
80103d67:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103d6c:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80103d72:	75 e2                	jne    80103d56 <wait+0x36>
80103d74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(!havekids || curproc->killed){
80103d78:	85 c0                	test   %eax,%eax
80103d7a:	74 7f                	je     80103dfb <wait+0xdb>
80103d7c:	8b 46 24             	mov    0x24(%esi),%eax
80103d7f:	85 c0                	test   %eax,%eax
80103d81:	75 78                	jne    80103dfb <wait+0xdb>
    sleep(curproc, &ptable.lock);  //DOC: wait-sleep
80103d83:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
80103d8a:	80 
80103d8b:	89 34 24             	mov    %esi,(%esp)
80103d8e:	e8 dd fe ff ff       	call   80103c70 <sleep>
  }
80103d93:	eb aa                	jmp    80103d3f <wait+0x1f>
        kfree(p->kstack);
80103d95:	8b 43 08             	mov    0x8(%ebx),%eax
        pid = p->pid;
80103d98:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80103d9b:	89 04 24             	mov    %eax,(%esp)
80103d9e:	e8 4d e5 ff ff       	call   801022f0 <kfree>
        freevm(p->pgdir);
80103da3:	8b 43 04             	mov    0x4(%ebx),%eax
        p->kstack = 0;
80103da6:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103dad:	89 04 24             	mov    %eax,(%esp)
80103db0:	e8 8b 2f 00 00       	call   80106d40 <freevm>
	if(status) *status = p->exitStatus;
80103db5:	85 ff                	test   %edi,%edi
        p->pid = 0;
80103db7:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103dbe:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        p->name[0] = 0;
80103dc5:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
        p->killed = 0;
80103dc9:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
        p->state = UNUSED;
80103dd0:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
	if(status) *status = p->exitStatus;
80103dd7:	74 05                	je     80103dde <wait+0xbe>
80103dd9:	8b 43 7c             	mov    0x7c(%ebx),%eax
80103ddc:	89 07                	mov    %eax,(%edi)
        release(&ptable.lock);
80103dde:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
	p->exitStatus = 0;
80103de5:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
        release(&ptable.lock);
80103dec:	e8 af 07 00 00       	call   801045a0 <release>
}
80103df1:	83 c4 1c             	add    $0x1c,%esp
        return pid;
...
80103dfa:	c3                   	ret    
      release(&ptable.lock);
80103dfb:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103e02:	e8 99 07 00 00       	call   801045a0 <release>
}
80103e07:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80103e31:	e8 fa 06 00 00       	call   80104530 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e36:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103e3b:	eb 0f                	jmp    80103e4c <wakeup+0x2c>
80103e3d:	8d 76 00             	lea    0x0(%esi),%esi
80103e40:	05 84 00 00 00       	add    $0x84,%eax
80103e45:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103e4a:	74 24                	je     80103e70 <wakeup+0x50>
    if(p->state == SLEEPING && p->chan == chan)
80103e4c:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
80103e50:	75 ee                	jne    80103e40 <wakeup+0x20>
80103e52:	3b 58 20             	cmp    0x20(%eax),%ebx
80103e55:	75 e9                	jne    80103e40 <wakeup+0x20>
      p->state = RUNNABLE;
80103e57:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103e5e:	05 84 00 00 00       	add    $0x84,%eax
80103e63:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103e68:	75 e2                	jne    80103e4c <wakeup+0x2c>
80103e6a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  wakeup1(chan);
  release(&ptable.lock);
80103e70:	c7 45 08 20 2d 11 80 	movl   $0x80112d20,0x8(%ebp)
}
80103e77:	83 c4 14             	add    $0x14,%esp
80103e7a:	5b                   	pop    %ebx
80103e7b:	5d                   	pop    %ebp
  release(&ptable.lock);
80103e7c:	e9 1f 07 00 00       	jmp    801045a0 <release>
80103e81:	eb 0d                	jmp    80103e90 <kill>
80103e83:	90                   	nop
80103e84:	90                   	nop
80103e85:	90                   	nop
80103e86:	90                   	nop
...
80103ea1:	e8 8a 06 00 00       	call   80104530 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ea6:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103eab:	eb 0f                	jmp    80103ebc <kill+0x2c>
80103ead:	8d 76 00             	lea    0x0(%esi),%esi
80103eb0:	05 84 00 00 00       	add    $0x84,%eax
80103eb5:	3d 54 4e 11 80       	cmp    $0x80114e54,%eax
80103eba:	74 3c                	je     80103ef8 <kill+0x68>
    if(p->pid == pid){
80103ebc:	39 58 10             	cmp    %ebx,0x10(%eax)
80103ebf:	75 ef                	jne    80103eb0 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80103ec1:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
80103ec5:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
      if(p->state == SLEEPING)
80103ecc:	74 1a                	je     80103ee8 <kill+0x58>
        p->state = RUNNABLE;
      release(&ptable.lock);
80103ece:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103ed5:	e8 c6 06 00 00       	call   801045a0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80103eda:	83 c4 14             	add    $0x14,%esp
      return 0;
...
80103f16:	bb c0 2d 11 80       	mov    $0x80112dc0,%ebx
80103f1b:	83 ec 4c             	sub    $0x4c,%esp
80103f1e:	8d 75 e8             	lea    -0x18(%ebp),%esi
80103f21:	eb 23                	jmp    80103f46 <procdump+0x36>
80103f23:	90                   	nop
80103f24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103f28:	c7 04 24 e7 79 10 80 	movl   $0x801079e7,(%esp)
80103f2f:	e8 1c c7 ff ff       	call   80100650 <cprintf>
80103f34:	81 c3 84 00 00 00    	add    $0x84,%ebx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f3a:	81 fb c0 4e 11 80    	cmp    $0x80114ec0,%ebx
80103f40:	0f 84 8a 00 00 00    	je     80103fd0 <procdump+0xc0>
    if(p->state == UNUSED)
80103f46:	8b 43 a0             	mov    -0x60(%ebx),%eax
80103f49:	85 c0                	test   %eax,%eax
80103f4b:	74 e7                	je     80103f34 <procdump+0x24>
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103f4d:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103f50:	ba 60 76 10 80       	mov    $0x80107660,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103f55:	77 11                	ja     80103f68 <procdump+0x58>
80103f57:	8b 14 85 c0 76 10 80 	mov    -0x7fef8940(,%eax,4),%edx
      state = "???";
80103f5e:	b8 60 76 10 80       	mov    $0x80107660,%eax
80103f63:	85 d2                	test   %edx,%edx
80103f65:	0f 44 d0             	cmove  %eax,%edx
    cprintf("%d %s %s", p->pid, state, p->name);
80103f68:	8b 43 a4             	mov    -0x5c(%ebx),%eax
80103f6b:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80103f6f:	89 54 24 08          	mov    %edx,0x8(%esp)
80103f73:	c7 04 24 64 76 10 80 	movl   $0x80107664,(%esp)
80103f7a:	89 44 24 04          	mov    %eax,0x4(%esp)
80103f7e:	e8 cd c6 ff ff       	call   80100650 <cprintf>
    if(p->state == SLEEPING){
80103f83:	83 7b a0 02          	cmpl   $0x2,-0x60(%ebx)
80103f87:	75 9f                	jne    80103f28 <procdump+0x18>
      getcallerpcs((uint*)p->context->ebp+2, pc);
80103f89:	8d 45 c0             	lea    -0x40(%ebp),%eax
80103f8c:	89 44 24 04          	mov    %eax,0x4(%esp)
80103f90:	8b 43 b0             	mov    -0x50(%ebx),%eax
80103f93:	8d 7d c0             	lea    -0x40(%ebp),%edi
80103f96:	8b 40 0c             	mov    0xc(%eax),%eax
80103f99:	83 c0 08             	add    $0x8,%eax
80103f9c:	89 04 24             	mov    %eax,(%esp)
80103f9f:	e8 3c 04 00 00       	call   801043e0 <getcallerpcs>
80103fa4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      for(i=0; i<10 && pc[i] != 0; i++)
80103fa8:	8b 17                	mov    (%edi),%edx
80103faa:	85 d2                	test   %edx,%edx
80103fac:	0f 84 76 ff ff ff    	je     80103f28 <procdump+0x18>
        cprintf(" %p", pc[i]);
80103fb2:	89 54 24 04          	mov    %edx,0x4(%esp)
80103fb6:	83 c7 04             	add    $0x4,%edi
80103fb9:	c7 04 24 a1 70 10 80 	movl   $0x801070a1,(%esp)
80103fc0:	e8 8b c6 ff ff       	call   80100650 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80103fc5:	39 f7                	cmp    %esi,%edi
...
80103fe3:	56                   	push   %esi
  ...
  if(curproc == initproc)
80103fe4:	31 f6                	xor    %esi,%esi
{
80103fe6:	53                   	push   %ebx
80103fe7:	83 ec 10             	sub    $0x10,%esp
  struct proc *curproc = myproc();
80103fea:	e8 c1 f6 ff ff       	call   801036b0 <myproc>
  if(curproc == initproc)
80103fef:	3b 05 b8 a5 10 80    	cmp    0x8010a5b8,%eax
  struct proc *curproc = myproc();
80103ff5:	89 c3                	mov    %eax,%ebx
  if(curproc == initproc)
80103ff7:	0f 84 03 01 00 00    	je     80104100 <exitUDef+0x120>
...
80104006:	74 10                	je     80104018 <exitUDef+0x38>
      fileclose(curproc->ofile[fd]);
80104008:	89 04 24             	mov    %eax,(%esp)
8010400b:	e8 20 ce ff ff       	call   80100e30 <fileclose>
      curproc->ofile[fd] = 0;
80104010:	c7 44 b3 28 00 00 00 	movl   $0x0,0x28(%ebx,%esi,4)
80104017:	00 
  for(fd = 0; fd < NOFILE; fd++){
80104018:	83 c6 01             	add    $0x1,%esi
8010401b:	83 fe 10             	cmp    $0x10,%esi
8010401e:	75 e0                	jne    80104000 <exitUDef+0x20>
    }
  }

  begin_op();
80104020:	e8 eb ea ff ff       	call   80102b10 <begin_op>
  iput(curproc->cwd);
80104025:	8b 43 68             	mov    0x68(%ebx),%eax
80104028:	89 04 24             	mov    %eax,(%esp)
8010402b:	e8 a0 d7 ff ff       	call   801017d0 <iput>
  end_op();
80104030:	e8 4b eb ff ff       	call   80102b80 <end_op>
  curproc->cwd = 0;
80104035:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)

  acquire(&ptable.lock);
8010403c:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104043:	e8 e8 04 00 00       	call   80104530 <acquire>

  // Parent might be sleeping in wait().
  wakeup1(curproc->parent);
80104048:	8b 43 14             	mov    0x14(%ebx),%eax
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010404b:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
80104050:	eb 14                	jmp    80104066 <exitUDef+0x86>
80104052:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104058:	81 c2 84 00 00 00    	add    $0x84,%edx
8010405e:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80104064:	74 20                	je     80104086 <exitUDef+0xa6>
    if(p->state == SLEEPING && p->chan == chan)
80104066:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
8010406a:	75 ec                	jne    80104058 <exitUDef+0x78>
8010406c:	3b 42 20             	cmp    0x20(%edx),%eax
8010406f:	75 e7                	jne    80104058 <exitUDef+0x78>
      p->state = RUNNABLE;
80104071:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104078:	81 c2 84 00 00 00    	add    $0x84,%edx
8010407e:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
80104084:	75 e0                	jne    80104066 <exitUDef+0x86>
  
  // Pass abandoned children to init.
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
80104086:	a1 b8 a5 10 80       	mov    0x8010a5b8,%eax
8010408b:	b9 54 2d 11 80       	mov    $0x80112d54,%ecx
80104090:	eb 14                	jmp    801040a6 <exitUDef+0xc6>
80104092:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104098:	81 c1 84 00 00 00    	add    $0x84,%ecx
8010409e:	81 f9 54 4e 11 80    	cmp    $0x80114e54,%ecx
801040a4:	74 3c                	je     801040e2 <exitUDef+0x102>
    if(p->parent == curproc){
801040a6:	39 59 14             	cmp    %ebx,0x14(%ecx)
801040a9:	75 ed                	jne    80104098 <exitUDef+0xb8>
      if(p->state == ZOMBIE)
801040ab:	83 79 0c 05          	cmpl   $0x5,0xc(%ecx)
      p->parent = initproc;
801040af:	89 41 14             	mov    %eax,0x14(%ecx)
      if(p->state == ZOMBIE)
801040b2:	75 e4                	jne    80104098 <exitUDef+0xb8>
801040b4:	ba 54 2d 11 80       	mov    $0x80112d54,%edx
801040b9:	eb 13                	jmp    801040ce <exitUDef+0xee>
801040bb:	90                   	nop
801040bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040c0:	81 c2 84 00 00 00    	add    $0x84,%edx
801040c6:	81 fa 54 4e 11 80    	cmp    $0x80114e54,%edx
801040cc:	74 ca                	je     80104098 <exitUDef+0xb8>
    if(p->state == SLEEPING && p->chan == chan)
801040ce:	83 7a 0c 02          	cmpl   $0x2,0xc(%edx)
801040d2:	75 ec                	jne    801040c0 <exitUDef+0xe0>
801040d4:	3b 42 20             	cmp    0x20(%edx),%eax
801040d7:	75 e7                	jne    801040c0 <exitUDef+0xe0>
      p->state = RUNNABLE;
801040d9:	c7 42 0c 03 00 00 00 	movl   $0x3,0xc(%edx)
801040e0:	eb de                	jmp    801040c0 <exitUDef+0xe0>
    }
  }
...
801040e2:	8b 45 08             	mov    0x8(%ebp),%eax
  curproc->state = ZOMBIE;
801040e5:	c7 43 0c 05 00 00 00 	movl   $0x5,0xc(%ebx)
  curproc->exitStatus = status;
801040ec:	89 43 7c             	mov    %eax,0x7c(%ebx)
  sched();
801040ef:	e8 6c f9 ff ff       	call   80103a60 <sched>
  panic("zombie exit");
801040f4:	c7 04 24 3d 76 10 80 	movl   $0x8010763d,(%esp)
801040fb:	e8 60 c2 ff ff       	call   80100360 <panic>
    panic("init exiting");
80104100:	c7 04 24 30 76 10 80 	movl   $0x80107630,(%esp)
80104107:	e8 54 c2 ff ff       	call   80100360 <panic>
...
8010411c:	8b 7d 10             	mov    0x10(%ebp),%edi
8010411f:	89 55 e0             	mov    %edx,-0x20(%ebp)
  struct proc *p, *curproc = myproc();
80104122:	e8 89 f5 ff ff       	call   801036b0 <myproc>
  int processExists; //similar to havekids in wait()
  acquire(&ptable.lock);
80104127:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
  struct proc *p, *curproc = myproc();
8010412e:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  acquire(&ptable.lock);
80104131:	e8 fa 03 00 00       	call   80104530 <acquire>
80104136:	8b 55 e0             	mov    -0x20(%ebp),%edx
...
80104139:	31 c0                	xor    %eax,%eax
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010413b:	bb 54 2d 11 80       	mov    $0x80112d54,%ebx
80104140:	eb 14                	jmp    80104156 <waitpid+0x46>
80104142:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80104148:	81 c3 84 00 00 00    	add    $0x84,%ebx
8010414e:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
80104154:	74 29                	je     8010417f <waitpid+0x6f>
      // If the process pid does not match the given pid, no need to continue
      // with this process.
      if(p->pid != pid) continue;
80104156:	8b 73 10             	mov    0x10(%ebx),%esi
80104159:	39 d6                	cmp    %edx,%esi
8010415b:	75 eb                	jne    80104148 <waitpid+0x38>

      processExists = 1;
      if(p->state == ZOMBIE) {
8010415d:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
80104161:	74 4d                	je     801041b0 <waitpid+0xa0>
	p->state = UNUSED;
	if(status) *status = p->exitStatus;
	p->exitStatus = 0;
	release(&ptable.lock);
...
80104163:	83 ff 01             	cmp    $0x1,%edi
80104166:	0f 84 ad 00 00 00    	je     80104219 <waitpid+0x109>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
8010416c:	81 c3 84 00 00 00    	add    $0x84,%ebx
      processExists = 1;
80104172:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104177:	81 fb 54 4e 11 80    	cmp    $0x80114e54,%ebx
8010417d:	75 d7                	jne    80104156 <waitpid+0x46>
      } 
    }
...
80104181:	0f 84 aa 00 00 00    	je     80104231 <waitpid+0x121>
80104187:	8b 45 e4             	mov    -0x1c(%ebp),%eax
8010418a:	8b 40 24             	mov    0x24(%eax),%eax
8010418d:	85 c0                	test   %eax,%eax
8010418f:	0f 85 9c 00 00 00    	jne    80104231 <waitpid+0x121>
      release(&ptable.lock);
      return -1;
    }
...
80104198:	c7 44 24 04 20 2d 11 	movl   $0x80112d20,0x4(%esp)
8010419f:	80 
801041a0:	89 55 e0             	mov    %edx,-0x20(%ebp)
801041a3:	89 04 24             	mov    %eax,(%esp)
801041a6:	e8 c5 fa ff ff       	call   80103c70 <sleep>
  }
801041ab:	8b 55 e0             	mov    -0x20(%ebp),%edx
801041ae:	eb 89                	jmp    80104139 <waitpid+0x29>
	kfree(p->kstack);
801041b0:	8b 43 08             	mov    0x8(%ebx),%eax
801041b3:	89 04 24             	mov    %eax,(%esp)
801041b6:	e8 35 e1 ff ff       	call   801022f0 <kfree>
	freevm(p->pgdir);
801041bb:	8b 43 04             	mov    0x4(%ebx),%eax
	p->kstack = 0;
801041be:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
	freevm(p->pgdir);
801041c5:	89 04 24             	mov    %eax,(%esp)
801041c8:	e8 73 2b 00 00       	call   80106d40 <freevm>
	if(status) *status = p->exitStatus;
801041cd:	8b 55 0c             	mov    0xc(%ebp),%edx
	p->pid = 0;
801041d0:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
	p->parent = 0;
801041d7:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
	p->name[0] = 0;
801041de:	c6 43 6c 00          	movb   $0x0,0x6c(%ebx)
	if(status) *status = p->exitStatus;
801041e2:	85 d2                	test   %edx,%edx
	p->killed = 0;
801041e4:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
	p->state = UNUSED;
801041eb:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
	if(status) *status = p->exitStatus;
801041f2:	74 08                	je     801041fc <waitpid+0xec>
801041f4:	8b 43 7c             	mov    0x7c(%ebx),%eax
801041f7:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801041fa:	89 01                	mov    %eax,(%ecx)
	release(&ptable.lock);
801041fc:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
	p->exitStatus = 0;
80104203:	c7 43 7c 00 00 00 00 	movl   $0x0,0x7c(%ebx)
	release(&ptable.lock);
8010420a:	e8 91 03 00 00       	call   801045a0 <release>
}
8010420f:	83 c4 1c             	add    $0x1c,%esp
...
80104218:	c3                   	ret    
	release(&ptable.lock);
80104219:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
	return 0;
80104220:	31 f6                	xor    %esi,%esi
	release(&ptable.lock);
80104222:	e8 79 03 00 00       	call   801045a0 <release>
}
80104227:	83 c4 1c             	add    $0x1c,%esp
...
80104231:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
      return -1;
80104238:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
8010423d:	e8 5e 03 00 00       	call   801045a0 <release>
      return -1;
80104242:	eb cb                	jmp    8010420f <waitpid+0xff>
80104244:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
8010424a:	8d bf 00 00 00 00    	lea    0x0(%edi),%edi

80104250 <setPriority>:
...
80104253:	83 ec 08             	sub    $0x8,%esp
  struct proc *p = myproc();
80104256:	e8 55 f4 ff ff       	call   801036b0 <myproc>
  p->priority = priority;
8010425b:	8b 55 08             	mov    0x8(%ebp),%edx
8010425e:	89 90 80 00 00 00    	mov    %edx,0x80(%eax)
  return 0;
}
...
80104273:	83 ec 08             	sub    $0x8,%esp
  struct proc *curproc = myproc();
80104276:	e8 35 f4 ff ff       	call   801036b0 <myproc>
  return curproc->priority;
8010427b:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
}
80104281:	c9                   	leave  
80104282:	c3                   	ret    
...
801042f7:	e8 74 f9 ff ff       	call   80103c70 <sleep>
  while (lk->locked) {
...
80104302:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104308:	e8 a3 f3 ff ff       	call   801036b0 <myproc>
...
80104356:	e8 c5 fa ff ff       	call   80103e20 <wakeup>
  release(&lk->lk);
...
80104392:	e8 19 f3 ff ff       	call   801036b0 <myproc>
...
8010448b:	75 49                	jne    801044d6 <popcli+0x56>
  ...
  if(--mycpu()->ncli < 0)
8010448d:	e8 7e f1 ff ff       	call   80103610 <mycpu>
...
801044a5:	e8 66 f1 ff ff       	call   80103610 <mycpu>
...
801044b6:	66 90                	xchg   %ax,%ax
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044b8:	e8 53 f1 ff ff       	call   80103610 <mycpu>
...
801044c9:	c3                   	ret    
    panic("popcli");
801044ca:	c7 04 24 fa 76 10 80 	movl   $0x801076fa,(%esp)
801044d1:	e8 8a be ff ff       	call   80100360 <panic>
    panic("popcli - interruptible");
801044d6:	c7 04 24 e3 76 10 80 	movl   $0x801076e3,(%esp)
...
80104508:	e8 03 f1 ff ff       	call   80103610 <mycpu>
...
80104562:	e8 a9 f0 ff ff       	call   80103610 <mycpu>
...
80104584:	c3                   	ret    
    panic("acquire");
80104585:	c7 04 24 01 77 10 80 	movl   $0x80107701,(%esp)
...
801045d2:	e9 a9 fe ff ff       	jmp    80104480 <popcli>
    panic("release");
801045d7:	c7 04 24 09 77 10 80 	movl   $0x80107709,(%esp)
...
80104847:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010484a:	e8 61 ee ff ff       	call   801036b0 <myproc>
...
80104887:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010488a:	e8 21 ee ff ff       	call   801036b0 <myproc>
...
801048eb:	e8 c0 ed ff ff       	call   801036b0 <myproc>
...
80104918:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010491b:	e8 90 ed ff ff       	call   801036b0 <myproc>
...
801049b5:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
801049b8:	e8 f3 ec ff ff       	call   801036b0 <myproc>
...
801049c8:	83 fa 18             	cmp    $0x18,%edx
801049cb:	77 1b                	ja     801049e8 <syscall+0x38>
801049cd:	8b 14 85 40 77 10 80 	mov    -0x7fef88c0(,%eax,4),%edx
...
801049f6:	c7 04 24 11 77 10 80 	movl   $0x80107711,(%esp)
...
80104a26:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
80104a29:	e8 82 ec ff ff       	call   801036b0 <myproc>
...
80104b80:	c7 44 24 04 c4 77 10 	movl   $0x801077c4,0x4(%esp)
80104b87:	80 
...
80104b9b:	c7 44 24 04 c3 77 10 	movl   $0x801077c3,0x4(%esp)
80104ba2:	80 
...
80104bb1:	79 89                	jns    80104b3c <create+0xdc>
      panic("create dots");
80104bb3:	c7 04 24 b7 77 10 80 	movl   $0x801077b7,(%esp)
80104bba:	e8 a1 b7 ff ff       	call   80100360 <panic>
    panic("create: dirlink");
80104bbf:	c7 04 24 c6 77 10 80 	movl   $0x801077c6,(%esp)
80104bc6:	e8 95 b7 ff ff       	call   80100360 <panic>
    panic("create: ialloc");
80104bcb:	c7 04 24 a8 77 10 80 	movl   $0x801077a8,(%esp)
...
80104c09:	e8 a2 ea ff ff       	call   801036b0 <myproc>
...
80104d83:	78 23                	js     80104da8 <sys_close+0x38>
  myproc()->ofile[fd] = 0;
80104d85:	e8 26 e9 ff ff       	call   801036b0 <myproc>
...
80104f71:	c7 44 24 04 c4 77 10 	movl   $0x801077c4,0x4(%esp)
80104f78:	80 
...
80104f89:	c7 44 24 04 c3 77 10 	movl   $0x801077c3,0x4(%esp)
80104f90:	80 
...
801050dd:	c7 04 24 e8 77 10 80 	movl   $0x801077e8,(%esp)
801050e4:	e8 77 b2 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
801050e9:	c7 04 24 fa 77 10 80 	movl   $0x801077fa,(%esp)
801050f0:	e8 6b b2 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
801050f5:	c7 04 24 d6 77 10 80 	movl   $0x801077d6,(%esp)
...
80105345:	83 ec 20             	sub    $0x20,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105348:	e8 63 e3 ff ff       	call   801036b0 <myproc>
...
80105563:	5d                   	pop    %ebp
  return fork();
80105564:	e9 f7 e2 ff ff       	jmp    80103860 <fork>
...
80105573:	83 ec 08             	sub    $0x8,%esp
  exit();
80105576:	e8 85 e5 ff ff       	call   80103b00 <exit>
...
801055a7:	e8 74 e7 ff ff       	call   80103d20 <wait>
}
801055ac:	c9                   	leave  
801055ad:	c3                   	ret    
...
801055c4:	e8 17 f3 ff ff       	call   801048e0 <argint>
...
801055d3:	e8 b8 e8 ff ff       	call   80103e90 <kill>
}
801055d8:	c9                   	leave  
801055d9:	c3                   	ret    
...
801055f3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801055f6:	e8 b5 e0 ff ff       	call   801036b0 <myproc>
...
80105615:	e8 c6 f2 ff ff       	call   801048e0 <argint>
8010561a:	85 c0                	test   %eax,%eax
8010561c:	78 22                	js     80105640 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010561e:	e8 8d e0 ff ff       	call   801036b0 <myproc>
  if(growproc(n) < 0)
...
8010562b:	e8 c0 e1 ff ff       	call   801037f0 <growproc>
...
80105665:	e8 76 f2 ff ff       	call   801048e0 <argint>
8010566a:	85 c0                	test   %eax,%eax
8010566c:	78 7e                	js     801056ec <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010566e:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105675:	e8 b6 ee ff ff       	call   80104530 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010567a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010567d:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  while(ticks - ticks0 < n){
...
80105690:	c7 44 24 04 60 4e 11 	movl   $0x80114e60,0x4(%esp)
80105697:	80 
80105698:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
8010569f:	e8 cc e5 ff ff       	call   80103c70 <sleep>
  while(ticks - ticks0 < n){
801056a4:	a1 a0 56 11 80       	mov    0x801156a0,%eax
801056a9:	29 d8                	sub    %ebx,%eax
801056ab:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801056ae:	73 28                	jae    801056d8 <sys_sleep+0x88>
    if(myproc()->killed){
801056b0:	e8 fb df ff ff       	call   801036b0 <myproc>
801056b5:	8b 40 24             	mov    0x24(%eax),%eax
801056b8:	85 c0                	test   %eax,%eax
801056ba:	74 d4                	je     80105690 <sys_sleep+0x40>
      release(&tickslock);
801056bc:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801056c3:	e8 d8 ee ff ff       	call   801045a0 <release>
      return -1;
...
801056d4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&tickslock);
801056d8:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
801056df:	e8 bc ee ff ff       	call   801045a0 <release>
}
...
8010570e:	e8 1d ee ff ff       	call   80104530 <acquire>
  xticks = ticks;
80105713:	8b 1d a0 56 11 80    	mov    0x801156a0,%ebx
  release(&tickslock);
80105719:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105720:	e8 7b ee ff ff       	call   801045a0 <release>
  return xticks;
}
...
80105744:	e8 97 f1 ff ff       	call   801048e0 <argint>
80105749:	85 c0                	test   %eax,%eax
8010574b:	78 13                	js     80105760 <sys_exitUDef+0x30>
  return exitUDef(exitStatus);
8010574d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105750:	89 04 24             	mov    %eax,(%esp)
80105753:	e8 88 e8 ff ff       	call   80103fe0 <exitUDef>
}
80105758:	c9                   	leave  
80105759:	c3                   	ret    
...
80105776:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105779:	89 44 24 04          	mov    %eax,0x4(%esp)
8010577d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  int pid, options = 0;
80105784:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(argint(0, &pid) < 0) return -1;
8010578b:	e8 50 f1 ff ff       	call   801048e0 <argint>
80105790:	85 c0                	test   %eax,%eax
80105792:	78 54                	js     801057e8 <sys_waitpid+0x78>
  if(argptr(1, (void*)&status, sizeof(status)) < 0) return -1;
80105794:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105797:	c7 44 24 08 04 00 00 	movl   $0x4,0x8(%esp)
8010579e:	00 
8010579f:	89 44 24 04          	mov    %eax,0x4(%esp)
801057a3:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801057aa:	e8 61 f1 ff ff       	call   80104910 <argptr>
801057af:	85 c0                	test   %eax,%eax
801057b1:	78 35                	js     801057e8 <sys_waitpid+0x78>
  if(argint(2, &options) < 0) return -1;
801057b3:	8d 45 f0             	lea    -0x10(%ebp),%eax
801057b6:	89 44 24 04          	mov    %eax,0x4(%esp)
801057ba:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801057c1:	e8 1a f1 ff ff       	call   801048e0 <argint>
801057c6:	85 c0                	test   %eax,%eax
801057c8:	78 1e                	js     801057e8 <sys_waitpid+0x78>
...
801057d8:	8b 45 ec             	mov    -0x14(%ebp),%eax
801057db:	89 04 24             	mov    %eax,(%esp)
801057de:	e8 2d e9 ff ff       	call   80104110 <waitpid>
}
801057e3:	c9                   	leave  
801057e4:	c3                   	ret    
...
80105804:	e8 d7 f0 ff ff       	call   801048e0 <argint>
...
80105813:	e8 38 ea ff ff       	call   80104250 <setPriority>
}
80105818:	c9                   	leave  
80105819:	c3                   	ret    
...
80105833:	5d                   	pop    %ebp
  return getPriority();
80105834:	e9 37 ea ff ff       	jmp    80104270 <getPriority>
...
8010583a:	06                   	push   %es
  pushl %fs
8010583b:	0f a0                	push   %fs
  pushl %gs
8010583d:	0f a8                	push   %gs
  pushal
8010583f:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105840:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105844:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105846:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105848:	54                   	push   %esp
  call trap
80105849:	e8 e2 00 00 00       	call   80105930 <trap>
  addl $4, %esp
8010584e:	83 c4 04             	add    $0x4,%esp
...
80105851:	61                   	popa   
  popl %gs
80105852:	0f a9                	pop    %gs
  popl %fs
80105854:	0f a1                	pop    %fs
  popl %es
80105856:	07                   	pop    %es
  popl %ds
80105857:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105858:	83 c4 08             	add    $0x8,%esp
  iret
8010585b:	cf                   	iret   
...
80105874:	66 89 0c c5 a2 4e 11 	mov    %cx,-0x7feeb15e(,%eax,8)
8010587b:	80 
8010587c:	c6 04 c5 a4 4e 11 80 	movb   $0x0,-0x7feeb15c(,%eax,8)
80105883:	00 
80105884:	c6 04 c5 a5 4e 11 80 	movb   $0x8e,-0x7feeb15b(,%eax,8)
8010588b:	8e 
8010588c:	66 89 14 c5 a0 4e 11 	mov    %dx,-0x7feeb160(,%eax,8)
80105893:	80 
80105894:	c1 ea 10             	shr    $0x10,%edx
80105897:	66 89 14 c5 a6 4e 11 	mov    %dx,-0x7feeb15a(,%eax,8)
8010589e:	80 
  for(i = 0; i < 256; i++)
...
801058b9:	c7 44 24 04 09 78 10 	movl   $0x80107809,0x4(%esp)
801058c0:	80 
801058c1:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801058c8:	66 89 15 a2 50 11 80 	mov    %dx,0x801150a2
801058cf:	66 a3 a0 50 11 80    	mov    %ax,0x801150a0
801058d5:	c1 e8 10             	shr    $0x10,%eax
801058d8:	c6 05 a4 50 11 80 00 	movb   $0x0,0x801150a4
801058df:	c6 05 a5 50 11 80 ef 	movb   $0xef,0x801150a5
801058e6:	66 a3 a6 50 11 80    	mov    %ax,0x801150a6
  initlock(&tickslock, "time");
801058ec:	e8 cf ea ff ff       	call   801043c0 <initlock>
}
801058f1:	c9                   	leave  
801058f2:	c3                   	ret    
...
8010590b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010590f:	b8 a0 4e 11 80       	mov    $0x80114ea0,%eax
...
80105942:	0f 84 a0 01 00 00    	je     80105ae8 <trap+0x1b8>
    if(myproc()->killed)
      exit();
    return;
  }
...
8010594e:	77 08                	ja     80105958 <trap+0x28>
80105950:	ff 24 85 b0 78 10 80 	jmp    *-0x7fef8750(,%eax,4)
80105957:	90                   	nop
    lapiceoi();
    break;
...
80105958:	e8 53 dd ff ff       	call   801036b0 <myproc>
8010595d:	85 c0                	test   %eax,%eax
8010595f:	90                   	nop
80105960:	0f 84 fa 01 00 00    	je     80105b60 <trap+0x230>
80105966:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010596a:	0f 84 f0 01 00 00    	je     80105b60 <trap+0x230>
...
80105973:	8b 53 38             	mov    0x38(%ebx),%edx
80105976:	89 4d d8             	mov    %ecx,-0x28(%ebp)
80105979:	89 55 dc             	mov    %edx,-0x24(%ebp)
8010597c:	e8 0f dd ff ff       	call   80103690 <cpuid>
80105981:	8b 73 30             	mov    0x30(%ebx),%esi
80105984:	89 c7                	mov    %eax,%edi
80105986:	8b 43 34             	mov    0x34(%ebx),%eax
80105989:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
8010598c:	e8 1f dd ff ff       	call   801036b0 <myproc>
80105991:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105994:	e8 17 dd ff ff       	call   801036b0 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105999:	8b 55 dc             	mov    -0x24(%ebp),%edx
8010599c:	89 74 24 0c          	mov    %esi,0xc(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801059a0:	8b 75 e0             	mov    -0x20(%ebp),%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801059a3:	8b 4d d8             	mov    -0x28(%ebp),%ecx
801059a6:	89 7c 24 14          	mov    %edi,0x14(%esp)
801059aa:	89 54 24 18          	mov    %edx,0x18(%esp)
801059ae:	8b 55 e4             	mov    -0x1c(%ebp),%edx
            myproc()->pid, myproc()->name, tf->trapno,
801059b1:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801059b4:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
            myproc()->pid, myproc()->name, tf->trapno,
801059b8:	89 74 24 08          	mov    %esi,0x8(%esp)
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801059bc:	89 54 24 10          	mov    %edx,0x10(%esp)
801059c0:	8b 40 10             	mov    0x10(%eax),%eax
801059c3:	c7 04 24 6c 78 10 80 	movl   $0x8010786c,(%esp)
801059ca:	89 44 24 04          	mov    %eax,0x4(%esp)
801059ce:	e8 7d ac ff ff       	call   80100650 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801059d3:	e8 d8 dc ff ff       	call   801036b0 <myproc>
...
801059e0:	e8 cb dc ff ff       	call   801036b0 <myproc>
801059e5:	85 c0                	test   %eax,%eax
801059e7:	74 0c                	je     801059f5 <trap+0xc5>
801059e9:	e8 c2 dc ff ff       	call   801036b0 <myproc>
801059ee:	8b 50 24             	mov    0x24(%eax),%edx
801059f1:	85 d2                	test   %edx,%edx
801059f3:	75 4b                	jne    80105a40 <trap+0x110>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801059f5:	e8 b6 dc ff ff       	call   801036b0 <myproc>
801059fa:	85 c0                	test   %eax,%eax
801059fc:	74 0d                	je     80105a0b <trap+0xdb>
801059fe:	66 90                	xchg   %ax,%ax
80105a00:	e8 ab dc ff ff       	call   801036b0 <myproc>
80105a05:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105a09:	74 4d                	je     80105a58 <trap+0x128>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a0b:	e8 a0 dc ff ff       	call   801036b0 <myproc>
80105a10:	85 c0                	test   %eax,%eax
80105a12:	74 1d                	je     80105a31 <trap+0x101>
80105a14:	e8 97 dc ff ff       	call   801036b0 <myproc>
80105a19:	8b 40 24             	mov    0x24(%eax),%eax
80105a1c:	85 c0                	test   %eax,%eax
80105a1e:	74 11                	je     80105a31 <trap+0x101>
80105a20:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a24:	83 e0 03             	and    $0x3,%eax
80105a27:	66 83 f8 03          	cmp    $0x3,%ax
80105a2b:	0f 84 e8 00 00 00    	je     80105b19 <trap+0x1e9>
    exit();
}
80105a31:	83 c4 3c             	add    $0x3c,%esp
80105a34:	5b                   	pop    %ebx
80105a35:	5e                   	pop    %esi
80105a36:	5f                   	pop    %edi
80105a37:	5d                   	pop    %ebp
...
80105a39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a40:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a44:	83 e0 03             	and    $0x3,%eax
80105a47:	66 83 f8 03          	cmp    $0x3,%ax
80105a4b:	75 a8                	jne    801059f5 <trap+0xc5>
    exit();
80105a4d:	e8 ae e0 ff ff       	call   80103b00 <exit>
80105a52:	eb a1                	jmp    801059f5 <trap+0xc5>
...
80105a60:	75 a9                	jne    80105a0b <trap+0xdb>
    yield();
80105a62:	e8 c9 e1 ff ff       	call   80103c30 <yield>
80105a67:	eb a2                	jmp    80105a0b <trap+0xdb>
80105a69:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105a70:	e8 1b dc ff ff       	call   80103690 <cpuid>
80105a75:	85 c0                	test   %eax,%eax
80105a77:	0f 84 b3 00 00 00    	je     80105b30 <trap+0x200>
80105a7d:	8d 76 00             	lea    0x0(%esi),%esi
    lapiceoi();
80105a80:	e8 fb cc ff ff       	call   80102780 <lapiceoi>
    break;
80105a85:	e9 56 ff ff ff       	jmp    801059e0 <trap+0xb0>
...
80105a95:	e8 e6 cc ff ff       	call   80102780 <lapiceoi>
    break;
80105a9a:	e9 41 ff ff ff       	jmp    801059e0 <trap+0xb0>
80105a9f:	90                   	nop
    uartintr();
80105aa0:	e8 1b 02 00 00       	call   80105cc0 <uartintr>
    lapiceoi();
80105aa5:	e8 d6 cc ff ff       	call   80102780 <lapiceoi>
    break;
80105aaa:	e9 31 ff ff ff       	jmp    801059e0 <trap+0xb0>
80105aaf:	90                   	nop
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105ab0:	8b 7b 38             	mov    0x38(%ebx),%edi
80105ab3:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105ab7:	e8 d4 db ff ff       	call   80103690 <cpuid>
80105abc:	c7 04 24 14 78 10 80 	movl   $0x80107814,(%esp)
80105ac3:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80105ac7:	89 74 24 08          	mov    %esi,0x8(%esp)
80105acb:	89 44 24 04          	mov    %eax,0x4(%esp)
80105acf:	e8 7c ab ff ff       	call   80100650 <cprintf>
    lapiceoi();
80105ad4:	e8 a7 cc ff ff       	call   80102780 <lapiceoi>
    break;
80105ad9:	e9 02 ff ff ff       	jmp    801059e0 <trap+0xb0>
80105ade:	66 90                	xchg   %ax,%ax
    ideintr();
80105ae0:	e8 9b c5 ff ff       	call   80102080 <ideintr>
80105ae5:	eb 96                	jmp    80105a7d <trap+0x14d>
80105ae7:	90                   	nop
80105ae8:	90                   	nop
80105ae9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105af0:	e8 bb db ff ff       	call   801036b0 <myproc>
80105af5:	8b 70 24             	mov    0x24(%eax),%esi
80105af8:	85 f6                	test   %esi,%esi
80105afa:	75 2c                	jne    80105b28 <trap+0x1f8>
    myproc()->tf = tf;
80105afc:	e8 af db ff ff       	call   801036b0 <myproc>
80105b01:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b04:	e8 a7 ee ff ff       	call   801049b0 <syscall>
    if(myproc()->killed)
80105b09:	e8 a2 db ff ff       	call   801036b0 <myproc>
80105b0e:	8b 48 24             	mov    0x24(%eax),%ecx
80105b11:	85 c9                	test   %ecx,%ecx
80105b13:	0f 84 18 ff ff ff    	je     80105a31 <trap+0x101>
}
80105b19:	83 c4 3c             	add    $0x3c,%esp
80105b1c:	5b                   	pop    %ebx
80105b1d:	5e                   	pop    %esi
80105b1e:	5f                   	pop    %edi
80105b1f:	5d                   	pop    %ebp
      exit();
80105b20:	e9 db df ff ff       	jmp    80103b00 <exit>
80105b25:	8d 76 00             	lea    0x0(%esi),%esi
      exit();
80105b28:	e8 d3 df ff ff       	call   80103b00 <exit>
80105b2d:	eb cd                	jmp    80105afc <trap+0x1cc>
80105b2f:	90                   	nop
      acquire(&tickslock);
80105b30:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105b37:	e8 f4 e9 ff ff       	call   80104530 <acquire>
      wakeup(&ticks);
80105b3c:	c7 04 24 a0 56 11 80 	movl   $0x801156a0,(%esp)
      ticks++;
80105b43:	83 05 a0 56 11 80 01 	addl   $0x1,0x801156a0
      wakeup(&ticks);
80105b4a:	e8 d1 e2 ff ff       	call   80103e20 <wakeup>
      release(&tickslock);
80105b4f:	c7 04 24 60 4e 11 80 	movl   $0x80114e60,(%esp)
80105b56:	e8 45 ea ff ff       	call   801045a0 <release>
80105b5b:	e9 1d ff ff ff       	jmp    80105a7d <trap+0x14d>
80105b60:	0f 20 d7             	mov    %cr2,%edi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105b63:	8b 73 38             	mov    0x38(%ebx),%esi
80105b66:	e8 25 db ff ff       	call   80103690 <cpuid>
80105b6b:	89 7c 24 10          	mov    %edi,0x10(%esp)
80105b6f:	89 74 24 0c          	mov    %esi,0xc(%esp)
80105b73:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b77:	8b 43 30             	mov    0x30(%ebx),%eax
80105b7a:	c7 04 24 38 78 10 80 	movl   $0x80107838,(%esp)
80105b81:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b85:	e8 c6 aa ff ff       	call   80100650 <cprintf>
      panic("trap");
80105b8a:	c7 04 24 0e 78 10 80 	movl   $0x8010780e,(%esp)
80105b91:	e8 ca a7 ff ff       	call   80100360 <panic>
...
80105baa:	74 14                	je     80105bc0 <uartgetc+0x20>
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
...
80105bb4:	74 0a                	je     80105bc0 <uartgetc+0x20>
80105bb6:	b2 f8                	mov    $0xf8,%dl
...
80105bd7:	74 3f                	je     80105c18 <uartputc+0x48>
{
...
80105be2:	53                   	push   %ebx
  if(!uart)
80105be3:	bb 80 00 00 00       	mov    $0x80,%ebx
{
80105be8:	83 ec 10             	sub    $0x10,%esp
80105beb:	eb 14                	jmp    80105c01 <uartputc+0x31>
80105bed:	8d 76 00             	lea    0x0(%esi),%esi
    microdelay(10);
80105bf0:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80105bf7:	e8 a4 cb ff ff       	call   801027a0 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105bfc:	83 eb 01             	sub    $0x1,%ebx
80105bff:	74 07                	je     80105c08 <uartputc+0x38>
80105c01:	89 f2                	mov    %esi,%edx
80105c03:	ec                   	in     (%dx),%al
80105c04:	a8 20                	test   $0x20,%al
80105c06:	74 e8                	je     80105bf0 <uartputc+0x20>
  outb(COM1+0, c);
80105c08:	0f b6 45 08          	movzbl 0x8(%ebp),%eax
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105c0c:	ba f8 03 00 00       	mov    $0x3f8,%edx
...
80105c47:	b2 f8                	mov    $0xf8,%dl
80105c49:	ee                   	out    %al,(%dx)
80105c4a:	bb f9 03 00 00       	mov    $0x3f9,%ebx
80105c4f:	89 c8                	mov    %ecx,%eax
80105c51:	89 da                	mov    %ebx,%edx
80105c53:	ee                   	out    %al,(%dx)
80105c54:	b8 03 00 00 00       	mov    $0x3,%eax
80105c59:	89 f2                	mov    %esi,%edx
80105c5b:	ee                   	out    %al,(%dx)
80105c5c:	b2 fc                	mov    $0xfc,%dl
80105c5e:	89 c8                	mov    %ecx,%eax
80105c60:	ee                   	out    %al,(%dx)
80105c61:	b8 01 00 00 00       	mov    $0x1,%eax
80105c66:	89 da                	mov    %ebx,%edx
80105c68:	ee                   	out    %al,(%dx)
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105c69:	b2 fd                	mov    $0xfd,%dl
80105c6b:	ec                   	in     (%dx),%al
  if(inb(COM1+5) == 0xFF)
80105c6c:	3c ff                	cmp    $0xff,%al
80105c6e:	74 42                	je     80105cb2 <uartinit+0x92>
  uart = 1;
80105c70:	c7 05 bc a5 10 80 01 	movl   $0x1,0x8010a5bc
80105c77:	00 00 00 
80105c7a:	89 fa                	mov    %edi,%edx
80105c7c:	ec                   	in     (%dx),%al
80105c7d:	b2 f8                	mov    $0xf8,%dl
80105c7f:	ec                   	in     (%dx),%al
  ioapicenable(IRQ_COM1, 0);
80105c80:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105c87:	00 
  for(p="xv6...\n"; *p; p++)
80105c88:	bb 30 79 10 80       	mov    $0x80107930,%ebx
  ioapicenable(IRQ_COM1, 0);
80105c8d:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80105c94:	e8 17 c6 ff ff       	call   801022b0 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
...
80105ca3:	83 c3 01             	add    $0x1,%ebx
    uartputc(*p);
80105ca6:	e8 25 ff ff ff       	call   80105bd0 <uartputc>
  for(p="xv6...\n"; *p; p++)
80105cab:	0f be 03             	movsbl (%ebx),%eax
80105cae:	84 c0                	test   %al,%al
80105cb0:	75 ee                	jne    80105ca0 <uartinit+0x80>
}
...
80105cc6:	c7 04 24 a0 5b 10 80 	movl   $0x80105ba0,(%esp)
...
80105cd6:	6a 00                	push   $0x0
  jmp alltraps
80105cd8:	e9 5c fb ff ff       	jmp    80105839 <alltraps>
...
80105cdf:	6a 01                	push   $0x1
  jmp alltraps
80105ce1:	e9 53 fb ff ff       	jmp    80105839 <alltraps>
...
80105ce8:	6a 02                	push   $0x2
  jmp alltraps
80105cea:	e9 4a fb ff ff       	jmp    80105839 <alltraps>
...
80105cf1:	6a 03                	push   $0x3
  jmp alltraps
80105cf3:	e9 41 fb ff ff       	jmp    80105839 <alltraps>
...
80105cfa:	6a 04                	push   $0x4
  jmp alltraps
80105cfc:	e9 38 fb ff ff       	jmp    80105839 <alltraps>
...
80105d03:	6a 05                	push   $0x5
  jmp alltraps
80105d05:	e9 2f fb ff ff       	jmp    80105839 <alltraps>
...
80105d0c:	6a 06                	push   $0x6
  jmp alltraps
80105d0e:	e9 26 fb ff ff       	jmp    80105839 <alltraps>
...
80105d15:	6a 07                	push   $0x7
  jmp alltraps
80105d17:	e9 1d fb ff ff       	jmp    80105839 <alltraps>
...
80105d1c:	6a 08                	push   $0x8
  jmp alltraps
80105d1e:	e9 16 fb ff ff       	jmp    80105839 <alltraps>
...
80105d25:	6a 09                	push   $0x9
  jmp alltraps
80105d27:	e9 0d fb ff ff       	jmp    80105839 <alltraps>
...
80105d2c:	6a 0a                	push   $0xa
  jmp alltraps
80105d2e:	e9 06 fb ff ff       	jmp    80105839 <alltraps>
...
80105d33:	6a 0b                	push   $0xb
  jmp alltraps
80105d35:	e9 ff fa ff ff       	jmp    80105839 <alltraps>
...
80105d3a:	6a 0c                	push   $0xc
  jmp alltraps
80105d3c:	e9 f8 fa ff ff       	jmp    80105839 <alltraps>
...
80105d41:	6a 0d                	push   $0xd
  jmp alltraps
80105d43:	e9 f1 fa ff ff       	jmp    80105839 <alltraps>
...
80105d48:	6a 0e                	push   $0xe
  jmp alltraps
80105d4a:	e9 ea fa ff ff       	jmp    80105839 <alltraps>
...
80105d51:	6a 0f                	push   $0xf
  jmp alltraps
80105d53:	e9 e1 fa ff ff       	jmp    80105839 <alltraps>
...
80105d5a:	6a 10                	push   $0x10
  jmp alltraps
80105d5c:	e9 d8 fa ff ff       	jmp    80105839 <alltraps>
...
80105d61:	6a 11                	push   $0x11
  jmp alltraps
80105d63:	e9 d1 fa ff ff       	jmp    80105839 <alltraps>
...
80105d6a:	6a 12                	push   $0x12
  jmp alltraps
80105d6c:	e9 c8 fa ff ff       	jmp    80105839 <alltraps>
...
80105d73:	6a 13                	push   $0x13
  jmp alltraps
80105d75:	e9 bf fa ff ff       	jmp    80105839 <alltraps>
...
80105d7c:	6a 14                	push   $0x14
  jmp alltraps
80105d7e:	e9 b6 fa ff ff       	jmp    80105839 <alltraps>
...
80105d85:	6a 15                	push   $0x15
  jmp alltraps
80105d87:	e9 ad fa ff ff       	jmp    80105839 <alltraps>
...
80105d8e:	6a 16                	push   $0x16
  jmp alltraps
80105d90:	e9 a4 fa ff ff       	jmp    80105839 <alltraps>
...
80105d97:	6a 17                	push   $0x17
  jmp alltraps
80105d99:	e9 9b fa ff ff       	jmp    80105839 <alltraps>
...
80105da0:	6a 18                	push   $0x18
  jmp alltraps
80105da2:	e9 92 fa ff ff       	jmp    80105839 <alltraps>
...
80105da9:	6a 19                	push   $0x19
  jmp alltraps
80105dab:	e9 89 fa ff ff       	jmp    80105839 <alltraps>
...
80105db2:	6a 1a                	push   $0x1a
  jmp alltraps
80105db4:	e9 80 fa ff ff       	jmp    80105839 <alltraps>
...
80105dbb:	6a 1b                	push   $0x1b
  jmp alltraps
80105dbd:	e9 77 fa ff ff       	jmp    80105839 <alltraps>
...
80105dc4:	6a 1c                	push   $0x1c
  jmp alltraps
80105dc6:	e9 6e fa ff ff       	jmp    80105839 <alltraps>
...
80105dcd:	6a 1d                	push   $0x1d
  jmp alltraps
80105dcf:	e9 65 fa ff ff       	jmp    80105839 <alltraps>
...
80105dd6:	6a 1e                	push   $0x1e
  jmp alltraps
80105dd8:	e9 5c fa ff ff       	jmp    80105839 <alltraps>
...
80105ddf:	6a 1f                	push   $0x1f
  jmp alltraps
80105de1:	e9 53 fa ff ff       	jmp    80105839 <alltraps>
...
80105de8:	6a 20                	push   $0x20
  jmp alltraps
80105dea:	e9 4a fa ff ff       	jmp    80105839 <alltraps>
...
80105df1:	6a 21                	push   $0x21
  jmp alltraps
80105df3:	e9 41 fa ff ff       	jmp    80105839 <alltraps>
...
80105dfa:	6a 22                	push   $0x22
  jmp alltraps
80105dfc:	e9 38 fa ff ff       	jmp    80105839 <alltraps>
...
80105e03:	6a 23                	push   $0x23
  jmp alltraps
80105e05:	e9 2f fa ff ff       	jmp    80105839 <alltraps>
...
80105e0c:	6a 24                	push   $0x24
  jmp alltraps
80105e0e:	e9 26 fa ff ff       	jmp    80105839 <alltraps>
...
80105e15:	6a 25                	push   $0x25
  jmp alltraps
80105e17:	e9 1d fa ff ff       	jmp    80105839 <alltraps>
...
80105e1e:	6a 26                	push   $0x26
  jmp alltraps
80105e20:	e9 14 fa ff ff       	jmp    80105839 <alltraps>
...
80105e27:	6a 27                	push   $0x27
  jmp alltraps
80105e29:	e9 0b fa ff ff       	jmp    80105839 <alltraps>
...
80105e30:	6a 28                	push   $0x28
  jmp alltraps
80105e32:	e9 02 fa ff ff       	jmp    80105839 <alltraps>
...
80105e39:	6a 29                	push   $0x29
  jmp alltraps
80105e3b:	e9 f9 f9 ff ff       	jmp    80105839 <alltraps>
...
80105e42:	6a 2a                	push   $0x2a
  jmp alltraps
80105e44:	e9 f0 f9 ff ff       	jmp    80105839 <alltraps>
...
80105e4b:	6a 2b                	push   $0x2b
  jmp alltraps
80105e4d:	e9 e7 f9 ff ff       	jmp    80105839 <alltraps>
...
80105e54:	6a 2c                	push   $0x2c
  jmp alltraps
80105e56:	e9 de f9 ff ff       	jmp    80105839 <alltraps>
...
80105e5d:	6a 2d                	push   $0x2d
  jmp alltraps
80105e5f:	e9 d5 f9 ff ff       	jmp    80105839 <alltraps>
...
80105e66:	6a 2e                	push   $0x2e
  jmp alltraps
80105e68:	e9 cc f9 ff ff       	jmp    80105839 <alltraps>
...
80105e6f:	6a 2f                	push   $0x2f
  jmp alltraps
80105e71:	e9 c3 f9 ff ff       	jmp    80105839 <alltraps>
...
80105e78:	6a 30                	push   $0x30
  jmp alltraps
80105e7a:	e9 ba f9 ff ff       	jmp    80105839 <alltraps>
...
80105e81:	6a 31                	push   $0x31
  jmp alltraps
80105e83:	e9 b1 f9 ff ff       	jmp    80105839 <alltraps>
...
80105e8a:	6a 32                	push   $0x32
  jmp alltraps
80105e8c:	e9 a8 f9 ff ff       	jmp    80105839 <alltraps>
...
80105e93:	6a 33                	push   $0x33
  jmp alltraps
80105e95:	e9 9f f9 ff ff       	jmp    80105839 <alltraps>
...
80105e9c:	6a 34                	push   $0x34
  jmp alltraps
80105e9e:	e9 96 f9 ff ff       	jmp    80105839 <alltraps>
...
80105ea5:	6a 35                	push   $0x35
  jmp alltraps
80105ea7:	e9 8d f9 ff ff       	jmp    80105839 <alltraps>
...
80105eae:	6a 36                	push   $0x36
  jmp alltraps
80105eb0:	e9 84 f9 ff ff       	jmp    80105839 <alltraps>
...
80105eb7:	6a 37                	push   $0x37
  jmp alltraps
80105eb9:	e9 7b f9 ff ff       	jmp    80105839 <alltraps>
...
80105ec0:	6a 38                	push   $0x38
  jmp alltraps
80105ec2:	e9 72 f9 ff ff       	jmp    80105839 <alltraps>
...
80105ec9:	6a 39                	push   $0x39
  jmp alltraps
80105ecb:	e9 69 f9 ff ff       	jmp    80105839 <alltraps>
...
80105ed2:	6a 3a                	push   $0x3a
  jmp alltraps
80105ed4:	e9 60 f9 ff ff       	jmp    80105839 <alltraps>
...
80105edb:	6a 3b                	push   $0x3b
  jmp alltraps
80105edd:	e9 57 f9 ff ff       	jmp    80105839 <alltraps>
...
80105ee4:	6a 3c                	push   $0x3c
  jmp alltraps
80105ee6:	e9 4e f9 ff ff       	jmp    80105839 <alltraps>
...
80105eed:	6a 3d                	push   $0x3d
  jmp alltraps
80105eef:	e9 45 f9 ff ff       	jmp    80105839 <alltraps>
...
80105ef6:	6a 3e                	push   $0x3e
  jmp alltraps
80105ef8:	e9 3c f9 ff ff       	jmp    80105839 <alltraps>
...
80105eff:	6a 3f                	push   $0x3f
  jmp alltraps
80105f01:	e9 33 f9 ff ff       	jmp    80105839 <alltraps>
...
80105f08:	6a 40                	push   $0x40
  jmp alltraps
80105f0a:	e9 2a f9 ff ff       	jmp    80105839 <alltraps>
...
80105f11:	6a 41                	push   $0x41
  jmp alltraps
80105f13:	e9 21 f9 ff ff       	jmp    80105839 <alltraps>
...
80105f1a:	6a 42                	push   $0x42
  jmp alltraps
80105f1c:	e9 18 f9 ff ff       	jmp    80105839 <alltraps>
...
80105f23:	6a 43                	push   $0x43
  jmp alltraps
80105f25:	e9 0f f9 ff ff       	jmp    80105839 <alltraps>
...
80105f2c:	6a 44                	push   $0x44
  jmp alltraps
80105f2e:	e9 06 f9 ff ff       	jmp    80105839 <alltraps>
...
80105f35:	6a 45                	push   $0x45
  jmp alltraps
80105f37:	e9 fd f8 ff ff       	jmp    80105839 <alltraps>
...
80105f3e:	6a 46                	push   $0x46
  jmp alltraps
80105f40:	e9 f4 f8 ff ff       	jmp    80105839 <alltraps>
...
80105f47:	6a 47                	push   $0x47
  jmp alltraps
80105f49:	e9 eb f8 ff ff       	jmp    80105839 <alltraps>
...
80105f50:	6a 48                	push   $0x48
  jmp alltraps
80105f52:	e9 e2 f8 ff ff       	jmp    80105839 <alltraps>
...
80105f59:	6a 49                	push   $0x49
  jmp alltraps
80105f5b:	e9 d9 f8 ff ff       	jmp    80105839 <alltraps>
...
80105f62:	6a 4a                	push   $0x4a
  jmp alltraps
80105f64:	e9 d0 f8 ff ff       	jmp    80105839 <alltraps>
...
80105f6b:	6a 4b                	push   $0x4b
  jmp alltraps
80105f6d:	e9 c7 f8 ff ff       	jmp    80105839 <alltraps>
...
80105f74:	6a 4c                	push   $0x4c
  jmp alltraps
80105f76:	e9 be f8 ff ff       	jmp    80105839 <alltraps>
...
80105f7d:	6a 4d                	push   $0x4d
  jmp alltraps
80105f7f:	e9 b5 f8 ff ff       	jmp    80105839 <alltraps>
...
80105f86:	6a 4e                	push   $0x4e
  jmp alltraps
80105f88:	e9 ac f8 ff ff       	jmp    80105839 <alltraps>
...
80105f8f:	6a 4f                	push   $0x4f
  jmp alltraps
80105f91:	e9 a3 f8 ff ff       	jmp    80105839 <alltraps>
...
80105f98:	6a 50                	push   $0x50
  jmp alltraps
80105f9a:	e9 9a f8 ff ff       	jmp    80105839 <alltraps>
...
80105fa1:	6a 51                	push   $0x51
  jmp alltraps
80105fa3:	e9 91 f8 ff ff       	jmp    80105839 <alltraps>
...
80105faa:	6a 52                	push   $0x52
  jmp alltraps
80105fac:	e9 88 f8 ff ff       	jmp    80105839 <alltraps>
...
80105fb3:	6a 53                	push   $0x53
  jmp alltraps
80105fb5:	e9 7f f8 ff ff       	jmp    80105839 <alltraps>
...
80105fbc:	6a 54                	push   $0x54
  jmp alltraps
80105fbe:	e9 76 f8 ff ff       	jmp    80105839 <alltraps>
...
80105fc5:	6a 55                	push   $0x55
  jmp alltraps
80105fc7:	e9 6d f8 ff ff       	jmp    80105839 <alltraps>
...
80105fce:	6a 56                	push   $0x56
  jmp alltraps
80105fd0:	e9 64 f8 ff ff       	jmp    80105839 <alltraps>
...
80105fd7:	6a 57                	push   $0x57
  jmp alltraps
80105fd9:	e9 5b f8 ff ff       	jmp    80105839 <alltraps>
...
80105fe0:	6a 58                	push   $0x58
  jmp alltraps
80105fe2:	e9 52 f8 ff ff       	jmp    80105839 <alltraps>
...
80105fe9:	6a 59                	push   $0x59
  jmp alltraps
80105feb:	e9 49 f8 ff ff       	jmp    80105839 <alltraps>
...
80105ff2:	6a 5a                	push   $0x5a
  jmp alltraps
80105ff4:	e9 40 f8 ff ff       	jmp    80105839 <alltraps>
...
80105ffb:	6a 5b                	push   $0x5b
  jmp alltraps
80105ffd:	e9 37 f8 ff ff       	jmp    80105839 <alltraps>
...
80106004:	6a 5c                	push   $0x5c
  jmp alltraps
80106006:	e9 2e f8 ff ff       	jmp    80105839 <alltraps>
...
8010600d:	6a 5d                	push   $0x5d
  jmp alltraps
8010600f:	e9 25 f8 ff ff       	jmp    80105839 <alltraps>
...
80106016:	6a 5e                	push   $0x5e
  jmp alltraps
80106018:	e9 1c f8 ff ff       	jmp    80105839 <alltraps>
...
8010601f:	6a 5f                	push   $0x5f
  jmp alltraps
80106021:	e9 13 f8 ff ff       	jmp    80105839 <alltraps>
...
80106028:	6a 60                	push   $0x60
  jmp alltraps
8010602a:	e9 0a f8 ff ff       	jmp    80105839 <alltraps>
...
80106031:	6a 61                	push   $0x61
  jmp alltraps
80106033:	e9 01 f8 ff ff       	jmp    80105839 <alltraps>
...
8010603a:	6a 62                	push   $0x62
  jmp alltraps
8010603c:	e9 f8 f7 ff ff       	jmp    80105839 <alltraps>
...
80106043:	6a 63                	push   $0x63
  jmp alltraps
80106045:	e9 ef f7 ff ff       	jmp    80105839 <alltraps>
...
8010604c:	6a 64                	push   $0x64
  jmp alltraps
8010604e:	e9 e6 f7 ff ff       	jmp    80105839 <alltraps>
...
80106055:	6a 65                	push   $0x65
  jmp alltraps
80106057:	e9 dd f7 ff ff       	jmp    80105839 <alltraps>
...
8010605e:	6a 66                	push   $0x66
  jmp alltraps
80106060:	e9 d4 f7 ff ff       	jmp    80105839 <alltraps>
...
80106067:	6a 67                	push   $0x67
  jmp alltraps
80106069:	e9 cb f7 ff ff       	jmp    80105839 <alltraps>
...
80106070:	6a 68                	push   $0x68
  jmp alltraps
80106072:	e9 c2 f7 ff ff       	jmp    80105839 <alltraps>
...
80106079:	6a 69                	push   $0x69
  jmp alltraps
8010607b:	e9 b9 f7 ff ff       	jmp    80105839 <alltraps>
...
80106082:	6a 6a                	push   $0x6a
  jmp alltraps
80106084:	e9 b0 f7 ff ff       	jmp    80105839 <alltraps>
...
8010608b:	6a 6b                	push   $0x6b
  jmp alltraps
8010608d:	e9 a7 f7 ff ff       	jmp    80105839 <alltraps>
...
80106094:	6a 6c                	push   $0x6c
  jmp alltraps
80106096:	e9 9e f7 ff ff       	jmp    80105839 <alltraps>
...
8010609d:	6a 6d                	push   $0x6d
  jmp alltraps
8010609f:	e9 95 f7 ff ff       	jmp    80105839 <alltraps>
...
801060a6:	6a 6e                	push   $0x6e
  jmp alltraps
801060a8:	e9 8c f7 ff ff       	jmp    80105839 <alltraps>
...
801060af:	6a 6f                	push   $0x6f
  jmp alltraps
801060b1:	e9 83 f7 ff ff       	jmp    80105839 <alltraps>
...
801060b8:	6a 70                	push   $0x70
  jmp alltraps
801060ba:	e9 7a f7 ff ff       	jmp    80105839 <alltraps>
...
801060c1:	6a 71                	push   $0x71
  jmp alltraps
801060c3:	e9 71 f7 ff ff       	jmp    80105839 <alltraps>
...
801060ca:	6a 72                	push   $0x72
  jmp alltraps
801060cc:	e9 68 f7 ff ff       	jmp    80105839 <alltraps>
...
801060d3:	6a 73                	push   $0x73
  jmp alltraps
801060d5:	e9 5f f7 ff ff       	jmp    80105839 <alltraps>
...
801060dc:	6a 74                	push   $0x74
  jmp alltraps
801060de:	e9 56 f7 ff ff       	jmp    80105839 <alltraps>
...
801060e5:	6a 75                	push   $0x75
  jmp alltraps
801060e7:	e9 4d f7 ff ff       	jmp    80105839 <alltraps>
...
801060ee:	6a 76                	push   $0x76
  jmp alltraps
801060f0:	e9 44 f7 ff ff       	jmp    80105839 <alltraps>
...
801060f7:	6a 77                	push   $0x77
  jmp alltraps
801060f9:	e9 3b f7 ff ff       	jmp    80105839 <alltraps>
...
80106100:	6a 78                	push   $0x78
  jmp alltraps
80106102:	e9 32 f7 ff ff       	jmp    80105839 <alltraps>
...
80106109:	6a 79                	push   $0x79
  jmp alltraps
8010610b:	e9 29 f7 ff ff       	jmp    80105839 <alltraps>
...
80106112:	6a 7a                	push   $0x7a
  jmp alltraps
80106114:	e9 20 f7 ff ff       	jmp    80105839 <alltraps>
...
8010611b:	6a 7b                	push   $0x7b
  jmp alltraps
8010611d:	e9 17 f7 ff ff       	jmp    80105839 <alltraps>
...
80106124:	6a 7c                	push   $0x7c
  jmp alltraps
80106126:	e9 0e f7 ff ff       	jmp    80105839 <alltraps>
...
8010612d:	6a 7d                	push   $0x7d
  jmp alltraps
8010612f:	e9 05 f7 ff ff       	jmp    80105839 <alltraps>
...
80106136:	6a 7e                	push   $0x7e
  jmp alltraps
80106138:	e9 fc f6 ff ff       	jmp    80105839 <alltraps>
...
8010613f:	6a 7f                	push   $0x7f
  jmp alltraps
80106141:	e9 f3 f6 ff ff       	jmp    80105839 <alltraps>
...
80106148:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010614d:	e9 e7 f6 ff ff       	jmp    80105839 <alltraps>
...
80106154:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106159:	e9 db f6 ff ff       	jmp    80105839 <alltraps>
...
80106160:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106165:	e9 cf f6 ff ff       	jmp    80105839 <alltraps>
...
8010616c:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106171:	e9 c3 f6 ff ff       	jmp    80105839 <alltraps>
...
80106178:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010617d:	e9 b7 f6 ff ff       	jmp    80105839 <alltraps>
...
80106184:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106189:	e9 ab f6 ff ff       	jmp    80105839 <alltraps>
...
80106190:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106195:	e9 9f f6 ff ff       	jmp    80105839 <alltraps>
...
8010619c:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801061a1:	e9 93 f6 ff ff       	jmp    80105839 <alltraps>
...
801061a8:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801061ad:	e9 87 f6 ff ff       	jmp    80105839 <alltraps>
...
801061b4:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801061b9:	e9 7b f6 ff ff       	jmp    80105839 <alltraps>
...
801061c0:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801061c5:	e9 6f f6 ff ff       	jmp    80105839 <alltraps>
...
801061cc:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801061d1:	e9 63 f6 ff ff       	jmp    80105839 <alltraps>
...
801061d8:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801061dd:	e9 57 f6 ff ff       	jmp    80105839 <alltraps>
...
801061e4:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801061e9:	e9 4b f6 ff ff       	jmp    80105839 <alltraps>
...
801061f0:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801061f5:	e9 3f f6 ff ff       	jmp    80105839 <alltraps>
...
801061fc:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106201:	e9 33 f6 ff ff       	jmp    80105839 <alltraps>
...
80106208:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010620d:	e9 27 f6 ff ff       	jmp    80105839 <alltraps>
...
80106214:	68 91 00 00 00       	push   $0x91
  jmp alltraps
80106219:	e9 1b f6 ff ff       	jmp    80105839 <alltraps>
...
80106220:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106225:	e9 0f f6 ff ff       	jmp    80105839 <alltraps>
...
8010622c:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106231:	e9 03 f6 ff ff       	jmp    80105839 <alltraps>
...
80106238:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010623d:	e9 f7 f5 ff ff       	jmp    80105839 <alltraps>
...
80106244:	68 95 00 00 00       	push   $0x95
  jmp alltraps
80106249:	e9 eb f5 ff ff       	jmp    80105839 <alltraps>
...
80106250:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106255:	e9 df f5 ff ff       	jmp    80105839 <alltraps>
...
8010625c:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106261:	e9 d3 f5 ff ff       	jmp    80105839 <alltraps>
...
80106268:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010626d:	e9 c7 f5 ff ff       	jmp    80105839 <alltraps>
...
80106274:	68 99 00 00 00       	push   $0x99
  jmp alltraps
80106279:	e9 bb f5 ff ff       	jmp    80105839 <alltraps>
...
80106280:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106285:	e9 af f5 ff ff       	jmp    80105839 <alltraps>
...
8010628c:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106291:	e9 a3 f5 ff ff       	jmp    80105839 <alltraps>
...
80106298:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010629d:	e9 97 f5 ff ff       	jmp    80105839 <alltraps>
...
801062a4:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801062a9:	e9 8b f5 ff ff       	jmp    80105839 <alltraps>
...
801062b0:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801062b5:	e9 7f f5 ff ff       	jmp    80105839 <alltraps>
...
801062bc:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801062c1:	e9 73 f5 ff ff       	jmp    80105839 <alltraps>
...
801062c8:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801062cd:	e9 67 f5 ff ff       	jmp    80105839 <alltraps>
...
801062d4:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801062d9:	e9 5b f5 ff ff       	jmp    80105839 <alltraps>
...
801062e0:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801062e5:	e9 4f f5 ff ff       	jmp    80105839 <alltraps>
...
801062ec:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801062f1:	e9 43 f5 ff ff       	jmp    80105839 <alltraps>
...
801062f8:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801062fd:	e9 37 f5 ff ff       	jmp    80105839 <alltraps>
...
80106304:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
80106309:	e9 2b f5 ff ff       	jmp    80105839 <alltraps>
...
80106310:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106315:	e9 1f f5 ff ff       	jmp    80105839 <alltraps>
...
8010631c:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106321:	e9 13 f5 ff ff       	jmp    80105839 <alltraps>
...
80106328:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010632d:	e9 07 f5 ff ff       	jmp    80105839 <alltraps>
...
80106334:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
80106339:	e9 fb f4 ff ff       	jmp    80105839 <alltraps>
...
80106340:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106345:	e9 ef f4 ff ff       	jmp    80105839 <alltraps>
...
8010634c:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106351:	e9 e3 f4 ff ff       	jmp    80105839 <alltraps>
...
80106358:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010635d:	e9 d7 f4 ff ff       	jmp    80105839 <alltraps>
...
80106364:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
80106369:	e9 cb f4 ff ff       	jmp    80105839 <alltraps>
...
80106370:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106375:	e9 bf f4 ff ff       	jmp    80105839 <alltraps>
...
8010637c:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106381:	e9 b3 f4 ff ff       	jmp    80105839 <alltraps>
...
80106388:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010638d:	e9 a7 f4 ff ff       	jmp    80105839 <alltraps>
...
80106394:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
80106399:	e9 9b f4 ff ff       	jmp    80105839 <alltraps>
...
801063a0:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801063a5:	e9 8f f4 ff ff       	jmp    80105839 <alltraps>
...
801063ac:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801063b1:	e9 83 f4 ff ff       	jmp    80105839 <alltraps>
...
801063b8:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801063bd:	e9 77 f4 ff ff       	jmp    80105839 <alltraps>
...
801063c4:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801063c9:	e9 6b f4 ff ff       	jmp    80105839 <alltraps>
...
801063d0:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801063d5:	e9 5f f4 ff ff       	jmp    80105839 <alltraps>
...
801063dc:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801063e1:	e9 53 f4 ff ff       	jmp    80105839 <alltraps>
...
801063e8:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801063ed:	e9 47 f4 ff ff       	jmp    80105839 <alltraps>
...
801063f4:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801063f9:	e9 3b f4 ff ff       	jmp    80105839 <alltraps>
...
80106400:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106405:	e9 2f f4 ff ff       	jmp    80105839 <alltraps>
...
8010640c:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106411:	e9 23 f4 ff ff       	jmp    80105839 <alltraps>
...
80106418:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010641d:	e9 17 f4 ff ff       	jmp    80105839 <alltraps>
...
80106424:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
80106429:	e9 0b f4 ff ff       	jmp    80105839 <alltraps>
...
80106430:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106435:	e9 ff f3 ff ff       	jmp    80105839 <alltraps>
...
8010643c:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106441:	e9 f3 f3 ff ff       	jmp    80105839 <alltraps>
...
80106448:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010644d:	e9 e7 f3 ff ff       	jmp    80105839 <alltraps>
...
80106454:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
80106459:	e9 db f3 ff ff       	jmp    80105839 <alltraps>
...
80106460:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106465:	e9 cf f3 ff ff       	jmp    80105839 <alltraps>
...
8010646c:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106471:	e9 c3 f3 ff ff       	jmp    80105839 <alltraps>
...
80106478:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010647d:	e9 b7 f3 ff ff       	jmp    80105839 <alltraps>
...
80106484:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
80106489:	e9 ab f3 ff ff       	jmp    80105839 <alltraps>
...
80106490:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106495:	e9 9f f3 ff ff       	jmp    80105839 <alltraps>
...
8010649c:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801064a1:	e9 93 f3 ff ff       	jmp    80105839 <alltraps>
...
801064a8:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801064ad:	e9 87 f3 ff ff       	jmp    80105839 <alltraps>
...
801064b4:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801064b9:	e9 7b f3 ff ff       	jmp    80105839 <alltraps>
...
801064c0:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801064c5:	e9 6f f3 ff ff       	jmp    80105839 <alltraps>
...
801064cc:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801064d1:	e9 63 f3 ff ff       	jmp    80105839 <alltraps>
...
801064d8:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801064dd:	e9 57 f3 ff ff       	jmp    80105839 <alltraps>
...
801064e4:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801064e9:	e9 4b f3 ff ff       	jmp    80105839 <alltraps>
...
801064f0:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801064f5:	e9 3f f3 ff ff       	jmp    80105839 <alltraps>
...
801064fc:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106501:	e9 33 f3 ff ff       	jmp    80105839 <alltraps>
...
80106508:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010650d:	e9 27 f3 ff ff       	jmp    80105839 <alltraps>
...
80106514:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
80106519:	e9 1b f3 ff ff       	jmp    80105839 <alltraps>
...
80106520:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106525:	e9 0f f3 ff ff       	jmp    80105839 <alltraps>
...
8010652c:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106531:	e9 03 f3 ff ff       	jmp    80105839 <alltraps>
...
80106538:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010653d:	e9 f7 f2 ff ff       	jmp    80105839 <alltraps>
...
80106544:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
80106549:	e9 eb f2 ff ff       	jmp    80105839 <alltraps>
...
80106550:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106555:	e9 df f2 ff ff       	jmp    80105839 <alltraps>
...
8010655c:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106561:	e9 d3 f2 ff ff       	jmp    80105839 <alltraps>
...
80106568:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010656d:	e9 c7 f2 ff ff       	jmp    80105839 <alltraps>
...
80106574:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
80106579:	e9 bb f2 ff ff       	jmp    80105839 <alltraps>
...
80106580:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106585:	e9 af f2 ff ff       	jmp    80105839 <alltraps>
...
8010658c:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106591:	e9 a3 f2 ff ff       	jmp    80105839 <alltraps>
...
80106598:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010659d:	e9 97 f2 ff ff       	jmp    80105839 <alltraps>
...
801065a4:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801065a9:	e9 8b f2 ff ff       	jmp    80105839 <alltraps>
...
801065b0:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801065b5:	e9 7f f2 ff ff       	jmp    80105839 <alltraps>
...
801065bc:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801065c1:	e9 73 f2 ff ff       	jmp    80105839 <alltraps>
...
801065c8:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801065cd:	e9 67 f2 ff ff       	jmp    80105839 <alltraps>
...
801065d4:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801065d9:	e9 5b f2 ff ff       	jmp    80105839 <alltraps>
...
801065e0:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801065e5:	e9 4f f2 ff ff       	jmp    80105839 <alltraps>
...
801065ec:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801065f1:	e9 43 f2 ff ff       	jmp    80105839 <alltraps>
...
801065f8:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801065fd:	e9 37 f2 ff ff       	jmp    80105839 <alltraps>
...
80106604:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
80106609:	e9 2b f2 ff ff       	jmp    80105839 <alltraps>
...
80106610:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106615:	e9 1f f2 ff ff       	jmp    80105839 <alltraps>
...
8010661c:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106621:	e9 13 f2 ff ff       	jmp    80105839 <alltraps>
...
80106628:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010662d:	e9 07 f2 ff ff       	jmp    80105839 <alltraps>
...
80106634:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
80106639:	e9 fb f1 ff ff       	jmp    80105839 <alltraps>
...
80106640:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106645:	e9 ef f1 ff ff       	jmp    80105839 <alltraps>
...
8010664c:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106651:	e9 e3 f1 ff ff       	jmp    80105839 <alltraps>
...
80106658:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010665d:	e9 d7 f1 ff ff       	jmp    80105839 <alltraps>
...
80106664:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106669:	e9 cb f1 ff ff       	jmp    80105839 <alltraps>
...
80106670:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106675:	e9 bf f1 ff ff       	jmp    80105839 <alltraps>
...
8010667c:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106681:	e9 b3 f1 ff ff       	jmp    80105839 <alltraps>
...
80106688:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010668d:	e9 a7 f1 ff ff       	jmp    80105839 <alltraps>
...
80106694:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106699:	e9 9b f1 ff ff       	jmp    80105839 <alltraps>
...
801066a0:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801066a5:	e9 8f f1 ff ff       	jmp    80105839 <alltraps>
...
801066ac:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801066b1:	e9 83 f1 ff ff       	jmp    80105839 <alltraps>
...
801066b8:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801066bd:	e9 77 f1 ff ff       	jmp    80105839 <alltraps>
...
801066c4:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801066c9:	e9 6b f1 ff ff       	jmp    80105839 <alltraps>
...
801066d0:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801066d5:	e9 5f f1 ff ff       	jmp    80105839 <alltraps>
...
801066dc:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801066e1:	e9 53 f1 ff ff       	jmp    80105839 <alltraps>
...
801066e8:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801066ed:	e9 47 f1 ff ff       	jmp    80105839 <alltraps>
...
801066f4:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801066f9:	e9 3b f1 ff ff       	jmp    80105839 <alltraps>
...
80106700:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106705:	e9 2f f1 ff ff       	jmp    80105839 <alltraps>
...
8010670c:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106711:	e9 23 f1 ff ff       	jmp    80105839 <alltraps>
...
80106718:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010671d:	e9 17 f1 ff ff       	jmp    80105839 <alltraps>
...
80106724:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106729:	e9 0b f1 ff ff       	jmp    80105839 <alltraps>
...
80106730:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106735:	e9 ff f0 ff ff       	jmp    80105839 <alltraps>
...
8010673c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106741:	e9 f3 f0 ff ff       	jmp    80105839 <alltraps>
...
8010676e:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
  ...
  return &pgtab[PTX(va)];
80106774:	c1 ee 0a             	shr    $0xa,%esi
}
80106777:	83 c4 1c             	add    $0x1c,%esp
  return &pgtab[PTX(va)];
8010677a:	89 f2                	mov    %esi,%edx
...
80106792:	74 34                	je     801067c8 <walkpgdir+0x78>
80106794:	e8 07 bd ff ff       	call   801024a0 <kalloc>
80106799:	85 c0                	test   %eax,%eax
8010679b:	89 c3                	mov    %eax,%ebx
8010679d:	74 29                	je     801067c8 <walkpgdir+0x78>
    memset(pgtab, 0, PGSIZE);
8010679f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801067a6:	00 
801067a7:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801067ae:	00 
801067af:	89 04 24             	mov    %eax,(%esp)
801067b2:	e8 39 de ff ff       	call   801045f0 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
801067b7:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
801067bd:	83 c8 07             	or     $0x7,%eax
801067c0:	89 07                	mov    %eax,(%edi)
801067c2:	eb b0                	jmp    80106774 <walkpgdir+0x24>
...
{
801067e8:	83 ec 1c             	sub    $0x1c,%esp
801067eb:	8b 7d 08             	mov    0x8(%ebp),%edi
  a = (char*)PGROUNDDOWN((uint)va);
801067ee:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
{
801067f4:	89 45 e0             	mov    %eax,-0x20(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801067f7:	8d 44 0a ff          	lea    -0x1(%edx,%ecx,1),%eax
801067fb:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
801067fe:	83 4d 0c 01          	orl    $0x1,0xc(%ebp)
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
80106802:	81 65 e4 00 f0 ff ff 	andl   $0xfffff000,-0x1c(%ebp)
80106809:	29 df                	sub    %ebx,%edi
8010680b:	eb 18                	jmp    80106825 <mappages+0x45>
8010680d:	8d 76 00             	lea    0x0(%esi),%esi
    if(*pte & PTE_P)
80106810:	f6 00 01             	testb  $0x1,(%eax)
80106813:	75 3d                	jne    80106852 <mappages+0x72>
    *pte = pa | perm | PTE_P;
80106815:	0b 75 0c             	or     0xc(%ebp),%esi
    if(a == last)
80106818:	3b 5d e4             	cmp    -0x1c(%ebp),%ebx
    *pte = pa | perm | PTE_P;
8010681b:	89 30                	mov    %esi,(%eax)
    if(a == last)
8010681d:	74 29                	je     80106848 <mappages+0x68>
      break;
    a += PGSIZE;
...
80106832:	e8 19 ff ff ff       	call   80106750 <walkpgdir>
...
8010683b:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80106851:	c3                   	ret    
      panic("remap");
80106852:	c7 04 24 38 79 10 80 	movl   $0x80107938,(%esp)
...
80106869:	53                   	push   %ebx
  ...
  a = PGROUNDUP(newsz);
8010686a:	8d 99 ff 0f 00 00    	lea    0xfff(%ecx),%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106870:	83 ec 1c             	sub    $0x1c,%esp
  a = PGROUNDUP(newsz);
80106873:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106879:	39 d3                	cmp    %edx,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
8010687b:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
8010687e:	72 3b                	jb     801068bb <deallocuvm.part.0+0x5b>
80106880:	eb 5e                	jmp    801068e0 <deallocuvm.part.0+0x80>
...
8010688d:	74 22                	je     801068b1 <deallocuvm.part.0+0x51>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
8010688f:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
80106895:	74 54                	je     801068eb <deallocuvm.part.0+0x8b>
        panic("kfree");
      char *v = P2V(pa);
80106897:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
8010689d:	89 14 24             	mov    %edx,(%esp)
801068a0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801068a3:	e8 48 ba ff ff       	call   801022f0 <kfree>
      *pte = 0;
801068a8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801068ab:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; a  < oldsz; a += PGSIZE){
801068b1:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801068b7:	39 f3                	cmp    %esi,%ebx
801068b9:	73 25                	jae    801068e0 <deallocuvm.part.0+0x80>
    pte = walkpgdir(pgdir, (char*)a, 0);
801068bb:	31 c9                	xor    %ecx,%ecx
801068bd:	89 da                	mov    %ebx,%edx
801068bf:	89 f8                	mov    %edi,%eax
801068c1:	e8 8a fe ff ff       	call   80106750 <walkpgdir>
    if(!pte)
801068c6:	85 c0                	test   %eax,%eax
801068c8:	75 be                	jne    80106888 <deallocuvm.part.0+0x28>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
801068ca:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
801068d0:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
801068d6:	81 c3 00 10 00 00    	add    $0x1000,%ebx
801068dc:	39 f3                	cmp    %esi,%ebx
801068de:	72 db                	jb     801068bb <deallocuvm.part.0+0x5b>
    }
  }
  return newsz;
}
801068e0:	8b 45 e0             	mov    -0x20(%ebp),%eax
801068e3:	83 c4 1c             	add    $0x1c,%esp
801068e6:	5b                   	pop    %ebx
801068e7:	5e                   	pop    %esi
801068e8:	5f                   	pop    %edi
801068e9:	5d                   	pop    %ebp
801068ea:	c3                   	ret    
        panic("kfree");
801068eb:	c7 04 24 c6 72 10 80 	movl   $0x801072c6,(%esp)
801068f2:	e8 69 9a ff ff       	call   80100360 <panic>
...
80106903:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106906:	e8 85 cd ff ff       	call   80103690 <cpuid>
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010690b:	31 c9                	xor    %ecx,%ecx
8010690d:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c = &cpus[cpuid()];
80106912:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
80106918:	05 80 27 11 80       	add    $0x80112780,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010691d:	66 89 50 78          	mov    %dx,0x78(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106921:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  lgdt(c->gdt, sizeof(c->gdt));
80106926:	83 c0 70             	add    $0x70,%eax
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106929:	66 89 48 0a          	mov    %cx,0xa(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010692d:	31 c9                	xor    %ecx,%ecx
8010692f:	66 89 50 10          	mov    %dx,0x10(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106933:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106938:	66 89 48 12          	mov    %cx,0x12(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010693c:	31 c9                	xor    %ecx,%ecx
8010693e:	66 89 50 18          	mov    %dx,0x18(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106942:	ba ff ff ff ff       	mov    $0xffffffff,%edx
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106947:	66 89 48 1a          	mov    %cx,0x1a(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010694b:	31 c9                	xor    %ecx,%ecx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010694d:	c6 40 0d 9a          	movb   $0x9a,0xd(%eax)
80106951:	c6 40 0e cf          	movb   $0xcf,0xe(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106955:	c6 40 15 92          	movb   $0x92,0x15(%eax)
80106959:	c6 40 16 cf          	movb   $0xcf,0x16(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
8010695d:	c6 40 1d fa          	movb   $0xfa,0x1d(%eax)
80106961:	c6 40 1e cf          	movb   $0xcf,0x1e(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106965:	c6 40 25 f2          	movb   $0xf2,0x25(%eax)
80106969:	c6 40 26 cf          	movb   $0xcf,0x26(%eax)
8010696d:	66 89 50 20          	mov    %dx,0x20(%eax)
  pd[0] = size-1;
80106971:	ba 2f 00 00 00       	mov    $0x2f,%edx
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
80106976:	c6 40 0c 00          	movb   $0x0,0xc(%eax)
8010697a:	c6 40 0f 00          	movb   $0x0,0xf(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
8010697e:	c6 40 14 00          	movb   $0x0,0x14(%eax)
80106982:	c6 40 17 00          	movb   $0x0,0x17(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106986:	c6 40 1c 00          	movb   $0x0,0x1c(%eax)
8010698a:	c6 40 1f 00          	movb   $0x0,0x1f(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010698e:	66 89 48 22          	mov    %cx,0x22(%eax)
80106992:	c6 40 24 00          	movb   $0x0,0x24(%eax)
80106996:	c6 40 27 00          	movb   $0x0,0x27(%eax)
8010699a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  pd[1] = (uint)p;
8010699e:	66 89 45 f4          	mov    %ax,-0xc(%ebp)
  pd[2] = (uint)p >> 16;
801069a2:	c1 e8 10             	shr    $0x10,%eax
801069a5:	66 89 45 f6          	mov    %ax,-0xa(%ebp)
  asm volatile("lgdt (%0)" : : "r" (pd));
801069a9:	8d 45 f2             	lea    -0xe(%ebp),%eax
801069ac:	0f 01 10             	lgdtl  (%eax)
}
801069af:	c9                   	leave  
801069b0:	c3                   	ret    
801069b1:	eb 0d                	jmp    801069c0 <switchkvm>
801069b3:	90                   	nop
801069b4:	90                   	nop
801069b5:	90                   	nop
801069b6:	90                   	nop
...
801069c0:	a1 a4 56 11 80       	mov    0x801156a4,%eax
{
...
80106a04:	0f 84 c3 00 00 00    	je     80106acd <switchuvm+0xed>
  pushcli();
80106a0a:	e8 31 da ff ff       	call   80104440 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106a0f:	e8 fc cb ff ff       	call   80103610 <mycpu>
80106a14:	89 c3                	mov    %eax,%ebx
80106a16:	e8 f5 cb ff ff       	call   80103610 <mycpu>
80106a1b:	89 c7                	mov    %eax,%edi
80106a1d:	e8 ee cb ff ff       	call   80103610 <mycpu>
80106a22:	83 c7 08             	add    $0x8,%edi
80106a25:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106a28:	e8 e3 cb ff ff       	call   80103610 <mycpu>
...
80106abb:	5d                   	pop    %ebp
  popcli();
80106abc:	e9 bf d9 ff ff       	jmp    80104480 <popcli>
    panic("switchuvm: no process");
80106ac1:	c7 04 24 3e 79 10 80 	movl   $0x8010793e,(%esp)
80106ac8:	e8 93 98 ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
80106acd:	c7 04 24 69 79 10 80 	movl   $0x80107969,(%esp)
80106ad4:	e8 87 98 ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
80106ad9:	c7 04 24 54 79 10 80 	movl   $0x80107954,(%esp)
...
80106b08:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106b0b:	77 54                	ja     80106b61 <inituvm+0x71>
  mem = kalloc();
80106b0d:	e8 8e b9 ff ff       	call   801024a0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b27:	e8 c4 da ff ff       	call   801045f0 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106b2c:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106b32:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106b37:	89 04 24             	mov    %eax,(%esp)
80106b3a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b3d:	31 d2                	xor    %edx,%edx
80106b3f:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106b46:	00 
80106b47:	e8 94 fc ff ff       	call   801067e0 <mappages>
  memmove(mem, init, sz);
80106b4c:	89 75 10             	mov    %esi,0x10(%ebp)
80106b4f:	89 7d 0c             	mov    %edi,0xc(%ebp)
80106b52:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80106b5b:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b5c:	e9 2f db ff ff       	jmp    80104690 <memmove>
    panic("inituvm: more than a page");
80106b61:	c7 04 24 7d 79 10 80 	movl   $0x8010797d,(%esp)
...
80106b80:	0f 85 98 00 00 00    	jne    80106c1e <loaduvm+0xae>
...
80106b8f:	eb 77                	jmp    80106c08 <loaduvm+0x98>
...
80106ba7:	76 5f                	jbe    80106c08 <loaduvm+0x98>
...
80106bb3:	e8 98 fb ff ff       	call   80106750 <walkpgdir>
80106bb8:	85 c0                	test   %eax,%eax
80106bba:	74 56                	je     80106c12 <loaduvm+0xa2>
    pa = PTE_ADDR(*pte);
80106bbc:	8b 00                	mov    (%eax),%eax
      n = PGSIZE;
80106bbe:	bf 00 10 00 00       	mov    $0x1000,%edi
80106bc3:	8b 4d 14             	mov    0x14(%ebp),%ecx
    pa = PTE_ADDR(*pte);
80106bc6:	25 00 f0 ff ff       	and    $0xfffff000,%eax
      n = PGSIZE;
80106bcb:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
80106bd1:	0f 42 fe             	cmovb  %esi,%edi
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106bd4:	05 00 00 00 80       	add    $0x80000000,%eax
80106bd9:	89 44 24 04          	mov    %eax,0x4(%esp)
80106bdd:	8b 45 10             	mov    0x10(%ebp),%eax
80106be0:	01 d9                	add    %ebx,%ecx
80106be2:	89 7c 24 0c          	mov    %edi,0xc(%esp)
80106be6:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106bea:	89 04 24             	mov    %eax,(%esp)
80106bed:	e8 6e ad ff ff       	call   80101960 <readi>
80106bf2:	39 f8                	cmp    %edi,%eax
80106bf4:	74 a2                	je     80106b98 <loaduvm+0x28>
}
80106bf6:	83 c4 1c             	add    $0x1c,%esp
      return -1;
...
80106c12:	c7 04 24 97 79 10 80 	movl   $0x80107997,(%esp)
80106c19:	e8 42 97 ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
80106c1e:	c7 04 24 38 7a 10 80 	movl   $0x80107a38,(%esp)
...
80106c3e:	0f 88 7e 00 00 00    	js     80106cc2 <allocuvm+0x92>
  if(newsz < oldsz)
80106c44:	3b 7d 0c             	cmp    0xc(%ebp),%edi
    return oldsz;
80106c47:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106c4a:	72 78                	jb     80106cc4 <allocuvm+0x94>
  a = PGROUNDUP(oldsz);
80106c4c:	8d 98 ff 0f 00 00    	lea    0xfff(%eax),%ebx
80106c52:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
  for(; a < newsz; a += PGSIZE){
80106c58:	39 df                	cmp    %ebx,%edi
80106c5a:	77 4a                	ja     80106ca6 <allocuvm+0x76>
80106c5c:	eb 72                	jmp    80106cd0 <allocuvm+0xa0>
80106c5e:	66 90                	xchg   %ax,%ax
    memset(mem, 0, PGSIZE);
80106c60:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106c67:	00 
80106c68:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106c6f:	00 
80106c70:	89 04 24             	mov    %eax,(%esp)
80106c73:	e8 78 d9 ff ff       	call   801045f0 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106c78:	8d 86 00 00 00 80    	lea    -0x80000000(%esi),%eax
80106c7e:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106c83:	89 04 24             	mov    %eax,(%esp)
80106c86:	8b 45 08             	mov    0x8(%ebp),%eax
80106c89:	89 da                	mov    %ebx,%edx
80106c8b:	c7 44 24 04 06 00 00 	movl   $0x6,0x4(%esp)
80106c92:	00 
80106c93:	e8 48 fb ff ff       	call   801067e0 <mappages>
80106c98:	85 c0                	test   %eax,%eax
80106c9a:	78 44                	js     80106ce0 <allocuvm+0xb0>
  for(; a < newsz; a += PGSIZE){
80106c9c:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106ca2:	39 df                	cmp    %ebx,%edi
80106ca4:	76 2a                	jbe    80106cd0 <allocuvm+0xa0>
    mem = kalloc();
80106ca6:	e8 f5 b7 ff ff       	call   801024a0 <kalloc>
    if(mem == 0){
80106cab:	85 c0                	test   %eax,%eax
    mem = kalloc();
80106cad:	89 c6                	mov    %eax,%esi
    if(mem == 0){
80106caf:	75 af                	jne    80106c60 <allocuvm+0x30>
      cprintf("allocuvm out of memory\n");
80106cb1:	c7 04 24 b5 79 10 80 	movl   $0x801079b5,(%esp)
80106cb8:	e8 93 99 ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80106cbd:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106cc0:	77 48                	ja     80106d0a <allocuvm+0xda>
      return 0;
80106cc2:	31 c0                	xor    %eax,%eax
}
80106cc4:	83 c4 1c             	add    $0x1c,%esp
80106cc7:	5b                   	pop    %ebx
80106cc8:	5e                   	pop    %esi
80106cc9:	5f                   	pop    %edi
80106cca:	5d                   	pop    %ebp
...
80106ce0:	c7 04 24 cd 79 10 80 	movl   $0x801079cd,(%esp)
80106ce7:	e8 64 99 ff ff       	call   80100650 <cprintf>
  if(newsz >= oldsz)
80106cec:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106cef:	76 0d                	jbe    80106cfe <allocuvm+0xce>
80106cf1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106cf4:	89 fa                	mov    %edi,%edx
80106cf6:	8b 45 08             	mov    0x8(%ebp),%eax
80106cf9:	e8 62 fb ff ff       	call   80106860 <deallocuvm.part.0>
      kfree(mem);
80106cfe:	89 34 24             	mov    %esi,(%esp)
80106d01:	e8 ea b5 ff ff       	call   801022f0 <kfree>
      return 0;
80106d06:	31 c0                	xor    %eax,%eax
80106d08:	eb ba                	jmp    80106cc4 <allocuvm+0x94>
80106d0a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106d0d:	89 fa                	mov    %edi,%edx
80106d0f:	8b 45 08             	mov    0x8(%ebp),%eax
80106d12:	e8 49 fb ff ff       	call   80106860 <deallocuvm.part.0>
      return 0;
80106d17:	31 c0                	xor    %eax,%eax
80106d19:	eb a9                	jmp    80106cc4 <allocuvm+0x94>
80106d1b:	90                   	nop
...
80106d2e:	73 08                	jae    80106d38 <deallocuvm+0x18>
}
80106d30:	5d                   	pop    %ebp
80106d31:	e9 2a fb ff ff       	jmp    80106860 <deallocuvm.part.0>
80106d36:	66 90                	xchg   %ax,%ax
80106d38:	89 d0                	mov    %edx,%eax
80106d3a:	5d                   	pop    %ebp
80106d3b:	c3                   	ret    
...
80106d48:	8b 75 08             	mov    0x8(%ebp),%esi
  uint i;

  if(pgdir == 0)
80106d4b:	85 f6                	test   %esi,%esi
80106d4d:	74 59                	je     80106da8 <freevm+0x68>
80106d4f:	31 c9                	xor    %ecx,%ecx
80106d51:	ba 00 00 00 80       	mov    $0x80000000,%edx
80106d56:	89 f0                	mov    %esi,%eax
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106d58:	31 db                	xor    %ebx,%ebx
80106d5a:	e8 01 fb ff ff       	call   80106860 <deallocuvm.part.0>
80106d5f:	eb 12                	jmp    80106d73 <freevm+0x33>
80106d61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106d68:	83 c3 01             	add    $0x1,%ebx
80106d6b:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80106d71:	74 27                	je     80106d9a <freevm+0x5a>
    if(pgdir[i] & PTE_P){
80106d73:	8b 14 9e             	mov    (%esi,%ebx,4),%edx
80106d76:	f6 c2 01             	test   $0x1,%dl
80106d79:	74 ed                	je     80106d68 <freevm+0x28>
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106d7b:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  for(i = 0; i < NPDENTRIES; i++){
80106d81:	83 c3 01             	add    $0x1,%ebx
      char * v = P2V(PTE_ADDR(pgdir[i]));
80106d84:	81 c2 00 00 00 80    	add    $0x80000000,%edx
      kfree(v);
80106d8a:	89 14 24             	mov    %edx,(%esp)
80106d8d:	e8 5e b5 ff ff       	call   801022f0 <kfree>
  for(i = 0; i < NPDENTRIES; i++){
80106d92:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
80106d98:	75 d9                	jne    80106d73 <freevm+0x33>
    }
  }
  kfree((char*)pgdir);
...
80106da2:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106da3:	e9 48 b5 ff ff       	jmp    801022f0 <kfree>
    panic("freevm: no pgdir");
80106da8:	c7 04 24 e9 79 10 80 	movl   $0x801079e9,(%esp)
80106daf:	e8 ac 95 ff ff       	call   80100360 <panic>
...
80106dc8:	e8 d3 b6 ff ff       	call   801024a0 <kalloc>
80106dcd:	85 c0                	test   %eax,%eax
80106dcf:	89 c6                	mov    %eax,%esi
80106dd1:	74 6d                	je     80106e40 <setupkvm+0x80>
  memset(pgdir, 0, PGSIZE);
80106dd3:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106dda:	00 
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106ddb:	bb 20 a4 10 80       	mov    $0x8010a420,%ebx
  memset(pgdir, 0, PGSIZE);
80106de0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106de7:	00 
80106de8:	89 04 24             	mov    %eax,(%esp)
80106deb:	e8 00 d8 ff ff       	call   801045f0 <memset>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106df0:	8b 53 0c             	mov    0xc(%ebx),%edx
80106df3:	8b 43 04             	mov    0x4(%ebx),%eax
80106df6:	8b 4b 08             	mov    0x8(%ebx),%ecx
80106df9:	89 54 24 04          	mov    %edx,0x4(%esp)
80106dfd:	8b 13                	mov    (%ebx),%edx
80106dff:	89 04 24             	mov    %eax,(%esp)
80106e02:	29 c1                	sub    %eax,%ecx
80106e04:	89 f0                	mov    %esi,%eax
80106e06:	e8 d5 f9 ff ff       	call   801067e0 <mappages>
80106e0b:	85 c0                	test   %eax,%eax
80106e0d:	78 19                	js     80106e28 <setupkvm+0x68>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80106e0f:	83 c3 10             	add    $0x10,%ebx
80106e12:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
80106e18:	72 d6                	jb     80106df0 <setupkvm+0x30>
80106e1a:	89 f0                	mov    %esi,%eax
}
...
80106e24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      freevm(pgdir);
80106e28:	89 34 24             	mov    %esi,(%esp)
80106e2b:	e8 10 ff ff ff       	call   80106d40 <freevm>
}
...
80106e42:	eb d8                	jmp    80106e1c <setupkvm+0x5c>
...
80106e53:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80106e56:	e8 65 ff ff ff       	call   80106dc0 <setupkvm>
80106e5b:	a3 a4 56 11 80       	mov    %eax,0x801156a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106e75:	83 ec 18             	sub    $0x18,%esp
  pte = walkpgdir(pgdir, uva, 0);
80106e78:	8b 55 0c             	mov    0xc(%ebp),%edx
80106e7b:	8b 45 08             	mov    0x8(%ebp),%eax
80106e7e:	e8 cd f8 ff ff       	call   80106750 <walkpgdir>
  if(pte == 0)
...
80106e8b:	c3                   	ret    
    panic("clearpteu");
80106e8c:	c7 04 24 fa 79 10 80 	movl   $0x801079fa,(%esp)
80106e93:	e8 c8 94 ff ff       	call   80100360 <panic>
80106e98:	90                   	nop
...
80106ea6:	83 ec 2c             	sub    $0x2c,%esp
  ...
  if((d = setupkvm()) == 0)
80106ea9:	e8 12 ff ff ff       	call   80106dc0 <setupkvm>
80106eae:	85 c0                	test   %eax,%eax
80106eb0:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106eb3:	0f 84 b9 00 00 00    	je     80106f72 <copyuvm+0xd2>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106ec6:	eb 48                	jmp    80106f10 <copyuvm+0x70>
...
80106ec8:	81 c6 00 00 00 80    	add    $0x80000000,%esi
80106ece:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106ed5:	00 
80106ed6:	89 74 24 04          	mov    %esi,0x4(%esp)
80106eda:	89 04 24             	mov    %eax,(%esp)
80106edd:	e8 ae d7 ff ff       	call   80104690 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106ee2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106ee5:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106eea:	89 fa                	mov    %edi,%edx
80106eec:	89 44 24 04          	mov    %eax,0x4(%esp)
80106ef0:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106ef6:	89 04 24             	mov    %eax,(%esp)
80106ef9:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106efc:	e8 df f8 ff ff       	call   801067e0 <mappages>
80106f01:	85 c0                	test   %eax,%eax
80106f03:	78 63                	js     80106f68 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106f05:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106f0b:	39 7d 0c             	cmp    %edi,0xc(%ebp)
80106f0e:	76 48                	jbe    80106f58 <copyuvm+0xb8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106f10:	8b 45 08             	mov    0x8(%ebp),%eax
80106f13:	31 c9                	xor    %ecx,%ecx
80106f15:	89 fa                	mov    %edi,%edx
80106f17:	e8 34 f8 ff ff       	call   80106750 <walkpgdir>
80106f1c:	85 c0                	test   %eax,%eax
80106f1e:	74 62                	je     80106f82 <copyuvm+0xe2>
    if(!(*pte & PTE_P))
80106f20:	8b 00                	mov    (%eax),%eax
80106f22:	a8 01                	test   $0x1,%al
80106f24:	74 50                	je     80106f76 <copyuvm+0xd6>
    pa = PTE_ADDR(*pte);
80106f26:	89 c6                	mov    %eax,%esi
    flags = PTE_FLAGS(*pte);
80106f28:	25 ff 0f 00 00       	and    $0xfff,%eax
80106f2d:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80106f30:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    if((mem = kalloc()) == 0)
80106f36:	e8 65 b5 ff ff       	call   801024a0 <kalloc>
80106f3b:	85 c0                	test   %eax,%eax
80106f3d:	89 c3                	mov    %eax,%ebx
80106f3f:	75 87                	jne    80106ec8 <copyuvm+0x28>
    }
  }
  return d;
...
bad:
  freevm(d);
80106f41:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106f44:	89 04 24             	mov    %eax,(%esp)
80106f47:	e8 f4 fd ff ff       	call   80106d40 <freevm>
  return 0;
80106f4c:	31 c0                	xor    %eax,%eax
}
80106f4e:	83 c4 2c             	add    $0x2c,%esp
80106f51:	5b                   	pop    %ebx
80106f52:	5e                   	pop    %esi
80106f53:	5f                   	pop    %edi
80106f54:	5d                   	pop    %ebp
...
80106f5b:	83 c4 2c             	add    $0x2c,%esp
80106f5e:	5b                   	pop    %ebx
80106f5f:	5e                   	pop    %esi
80106f60:	5f                   	pop    %edi
80106f61:	5d                   	pop    %ebp
...
80106f64:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      kfree(mem);
80106f68:	89 1c 24             	mov    %ebx,(%esp)
80106f6b:	e8 80 b3 ff ff       	call   801022f0 <kfree>
      goto bad;
80106f70:	eb cf                	jmp    80106f41 <copyuvm+0xa1>
    return 0;
80106f72:	31 c0                	xor    %eax,%eax
80106f74:	eb d8                	jmp    80106f4e <copyuvm+0xae>
      panic("copyuvm: page not present");
80106f76:	c7 04 24 1e 7a 10 80 	movl   $0x80107a1e,(%esp)
80106f7d:	e8 de 93 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106f82:	c7 04 24 04 7a 10 80 	movl   $0x80107a04,(%esp)
80106f89:	e8 d2 93 ff ff       	call   80100360 <panic>
...
80106fdc:	8b 4d 0c             	mov    0xc(%ebp),%ecx
...
80106fe4:	75 3a                	jne    80107020 <copyout+0x50>
80106fe6:	eb 68                	jmp    80107050 <copyout+0x80>
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
      return -1;
    n = PGSIZE - (va - va0);
80106fe8:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
80106feb:	89 f2                	mov    %esi,%edx
    if(n > len)
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80106fed:	89 7c 24 04          	mov    %edi,0x4(%esp)
    n = PGSIZE - (va - va0);
80106ff1:	29 ca                	sub    %ecx,%edx
80106ff3:	81 c2 00 10 00 00    	add    $0x1000,%edx
80106ff9:	39 da                	cmp    %ebx,%edx
80106ffb:	0f 47 d3             	cmova  %ebx,%edx
    memmove(pa0 + (va - va0), buf, n);
80106ffe:	29 f1                	sub    %esi,%ecx
80107000:	01 c8                	add    %ecx,%eax
80107002:	89 54 24 08          	mov    %edx,0x8(%esp)
80107006:	89 04 24             	mov    %eax,(%esp)
80107009:	89 55 e4             	mov    %edx,-0x1c(%ebp)
8010700c:	e8 7f d6 ff ff       	call   80104690 <memmove>
    len -= n;
    buf += n;
80107011:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    va = va0 + PGSIZE;
80107014:	8d 8e 00 10 00 00    	lea    0x1000(%esi),%ecx
    buf += n;
8010701a:	01 d7                	add    %edx,%edi
  while(len > 0){
8010701c:	29 d3                	sub    %edx,%ebx
8010701e:	74 30                	je     80107050 <copyout+0x80>
    pa0 = uva2ka(pgdir, (char*)va0);
80107020:	8b 45 08             	mov    0x8(%ebp),%eax
    va0 = (uint)PGROUNDDOWN(va);
80107023:	89 ce                	mov    %ecx,%esi
80107025:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    pa0 = uva2ka(pgdir, (char*)va0);
8010702b:	89 74 24 04          	mov    %esi,0x4(%esp)
    va0 = (uint)PGROUNDDOWN(va);
8010702f:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
80107032:	89 04 24             	mov    %eax,(%esp)
80107035:	e8 56 ff ff ff       	call   80106f90 <uva2ka>
    if(pa0 == 0)
8010703a:	85 c0                	test   %eax,%eax
8010703c:	75 aa                	jne    80106fe8 <copyout+0x18>
  }
  return 0;
}
8010703e:	83 c4 1c             	add    $0x1c,%esp
      return -1;
80107041:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
80107046:	5b                   	pop    %ebx
80107047:	5e                   	pop    %esi
80107048:	5f                   	pop    %edi
...
80107050:	83 c4 1c             	add    $0x1c,%esp
  return 0;
